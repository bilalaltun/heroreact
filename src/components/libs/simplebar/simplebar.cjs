...
(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined'
    ? factory(exports, require('can-use-dom'), require('simplebar-core'))
    : typeof define === 'function' && define.amd
    ? define(['exports', 'can-use-dom', 'simplebar-core'], factory)
    : ((global = typeof globalThis !== 'undefined' ? globalThis : global || self), factory((global.SimpleBar = {}), global.canUseDOM, global.SimpleBar));
})(this, function (exports, canUseDOM, SimpleBarCore) {
  'use strict';
  ...
  var SimpleBar = /** @class */ (function (_super) {
    ...
    SimpleBar.initDOMLoadedElements = function () {
      ...
      Array.prototype.forEach.call(document.querySelectorAll('[data-simplebar]'), function (el) {
        if (el.getAttribute('data-simplebar') !== 'init' && !SimpleBar.instances.has(el)) new SimpleBar(el, SimpleBarCore.getOptions(el.attributes));
      });
    };
