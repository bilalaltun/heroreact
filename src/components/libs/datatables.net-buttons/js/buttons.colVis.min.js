      ...
      colvis: function (o, i) {
        ...
        return (
          o.on('column-reorder.dt' + i.namespace, function (n, e, t) {
            o.button(null, o.button(null, l).node()).collectionRebuild([{ extend: 'columnsToggle', columns: i.columns, columnText: i.columnText }]);
          }),
          n
        );
      },
