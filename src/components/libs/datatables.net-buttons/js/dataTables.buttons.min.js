  ...
  y.extend(B.prototype, {
    ...
    processing: function (t, n) {
      ...
      return n === w
        ...
        : (y(o.node).toggleClass('processing', n), y(e.table().node()).triggerHandler('buttons-processing.dt', [n, e.button(t), e, y(t), o.conf]), this);
    },
    remove: function (t) {
    ...
    _expandButton: function (t, n, e, o, i, s, a) {
      for (
        var r, l = this.s.dt, c = this.c.dom.collection, u = Array.isArray(n) ? n : [n], d = 0, f = (u = n === w ? (Array.isArray(e) ? e : [e]) : u).length;
        d < f;
        d++
      ) {
    ...
    _buildButton: function (n, t, e, o) {
      ...
      return (
        ...
        { conf: n, node: (e ? h : l).get(0), inserter: e ? h : c, buttons: [], inCollection: t, isSplit: e, inSplit: o, collection: null, textNode: s }
      );
    },
    ...
    n = function (t) {
      ...
      return (n =
        'function' == typeof (n = '*' === t.filename && '*' !== t.title && t.title !== w && null !== t.title && '' !== t.title ? t.title : t.filename)
          ...
          : n) === w || null === n
        ? null
        : (n = (n = -1 !== n.indexOf('*') ? n.replace('*', y('head > title').text()).trim() : n).replace(/[^a-zA-Z0-9_\u00A1-\uFFFF\.,\-_ !\(\)]/g, '')) +
            (a(t.extension) || '');
    },
    a = function (t) {
