      ...
      if (f.isPlainObject(c)) K(c);
        ...
        if (E) {
          ...
          for (n = e.length; g < n; g++)
            (m = c.createAttribute(e[g].name.replace(':', '_dt_b_namespace_token_'))), (m.value = e[g].value), d.setAttributeNode(m);
        }
        c = I.serializeToString(c);
        E &&
          (-1 === c.indexOf('<?xml') && (c = '<?xml version="1.0" encoding="UTF-8" standalone="yes"?>' + c), (c = c.replace(/_dt_b_namespace_token_/g, ':')));
    ...
    receiveEvent: function (a, b) {
      ...
      switch (a) {
        ...
        case 'mouseout':
          this.domElement &&
            this.cssEffects &&
            ((this.recoverActive = !1), this.domElement.hasClass('active') && (this.domElement.removeClass('active'), (this.recoverActive = !0)));
          break;
        case 'mousedown':
    ...
    action: function (a, b, c, d) {
      d._fromFlash &&
        ...
        b.buttons.info(
          ...
          b.i18n('buttons.copySuccess', { _: 'Copied %d rows to clipboard', 1: 'Copied 1 row to clipboard' }, c.rows),
          3e3
        ));
    },
    fieldSeparator: '\t',
        ...
        v = function (k) {
          ...
          for (var h = 0, B = k.length; h < B; h++) {
            ...
            if (null !== k[h] && k[h] !== y && '' !== k[h]) {
              ...
              x ||
                ('number' === typeof k[h] || (k[h].match && k[h].match(/^-?\d+(\.\d+)?$/) && !k[h].match(/^0\d+/))
                  ? (x = t(e, 'c', { attr: { t: 'n', r: u }, children: [t(e, 'v', { text: k[h] })] }))
                  : ((w = k[h].replace ? k[h].replace(/[\x00-\x09\x0B\x0C\x0E-\x1F\x7F-\x9F]/g, '') : k[h]),
                    (x = t(e, 'c', { attr: { t: 'inlineStr', r: u }, children: { row: t(e, 'is', { children: { row: t(e, 't', { text: w }) } }) } }))));
              C.appendChild(x);
            }
          }
          n.appendChild(C);
