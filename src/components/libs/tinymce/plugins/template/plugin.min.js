...
!(function () {
  ...
  function p(e, t, n) {
    ...
    return (t = (t = (t = (t = (t = (t = (t = (t = (t = (t = (t = (t = (t = (t = (t = t.replace('%D', '%m/%d/%Y')).replace('%r', '%I:%M:%S %p')).replace(
      '%Y',
      '' + n.getFullYear()
    )).replace('%y', '' + n.getYear())).replace('%m', f(n.getMonth() + 1, 2))).replace('%d', f(n.getDate(), 2))).replace(
      '%H',
      '' + f(n.getHours(), 2)
    )).replace('%M', '' + f(n.getMinutes(), 2))).replace('%S', '' + f(n.getSeconds(), 2))).replace('%I', '' + (((n.getHours() + 11) % 12) + 1))).replace(
      '%p',
      n.getHours() < 12 ? 'AM' : 'PM'
    )).replace('%B', '' + e.translate(c[n.getMonth()]))).replace('%b', '' + e.translate(o[n.getMonth()]))).replace(
      '%A',
    ...
    c && 0 < c.length && (o = r.create('div', null)).appendChild(c[0].cloneNode(!0)),
      O.each(r.select('*', o), function (e) {
        g(e, t.getParam('template_cdate_classes', 'cdate').replace(/\s+/g, '|')) &&
          ...
          g(e, t.getParam('template_selected_content_classes', 'selcontent').replace(/\s+/g, '|')) && (e.innerHTML = a);
      }),
      d(t, o),
        ...
        return P.from(
          O.map(t, function (e, t) {
            ...
            return {
              selected: 0 === t,
              text: e.title,
              value: { url: n(e) ? P.from(e.url) : P.none(), content: n(e) ? P.none() : P.from(e.content), description: e.description },
            };
          })
        );
