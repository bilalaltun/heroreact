        ...
        for (var t, n, r, a = e.length; a--; )
          (n = (t = e[a]).attr('href')),
            ...
            n && -1 !== n.indexOf('#_msocom_')
              ? t.remove()
              : (!(n = n && 0 === n.indexOf('file://') ? (n = n.split('#')[1]) && '#' + n : n) && !r) || (r && !/^_?(?:toc|edn|ftn)/i.test(r))
              ? t.unwrap()
          ...
          for (
            var a,
              ...
              t = function (e, t, n) {
                ...
                (a = r !== i ? (r < i ? a && a.parent.parent : ((o = a), null)) : a) && a.name === t
                  ? a.append(e)
    ...
    return (
      ...
      o.hasEventListeners('PastePostProcess') && !p.isDefaultPrevented()
        ? ((u = i),
          ...
          j((d = l.fire('PastePostProcess', { node: f, internal: u, wordContent: c })).node.innerHTML, d.isDefaultPrevented()))
        ...
        (s = {
          pcIsSpace: !(a = function (e, t) {
            return -1 !== ' \f\t\v'.indexOf(t) || '\xa0' === t
              ? e.pcIsSpace || '' === e.str || e.str.length === i.length - 1 || ((n = e.str.length + 1) < i.length && 0 <= n && M(i[n]))
          ...
          function (r) {
            return (
              ...
              c(i, function (e) {
                return (
                  (t = e.toLowerCase()),
                  (he.hasOwn((n = { jpg: 'jpeg', jpe: 'jpeg', jfi: 'jpeg', jif: 'jpeg', jfif: 'jpeg', pjpeg: 'jpeg', pjp: 'jpeg', svg: 'svg+xml' }), t)
                    ? 'image/' + n[t]
                    : 'image/' + t) === r.type
                );
                var t, n;
                      ...
                      ? ((c = void 0),
                        (i = (o = t.editorUpload.blobCache).getByData(v, h))
                          ...
                          : ((l = (s = t.getParam('images_reuse_filename') && P(b.name))
                              ? ((f = t), P((d = b.name.match(/([\s\S]+?)(?:\.[a-z0-9.]+)$/i))) ? f.dom.encode(d[1]) : null)
                              : y),
                            (u = s ? b.name : void 0),
                ...
                if ('br' !== t) {
                  if ('wbr' !== t)
                    if ((c[t] && (u += ' '), f[t])) u += ' ';
                      ...
                      if ((3 === e.type && (u += e.value), !e.shortEnded && (e = e.firstChild))) for (; p(e), (e = e.next); );
                      d[t] && n.next && ((u += '\n'), 'p' === t && (u += '\n'));
                    }
                } else u += '\n';
              }),
    ...
    (s = o),
      ...
      s.on('keydown', function (e) {
        ...
        if (V(e) && !e.isDefaultPrevented() && (!(u = e.shiftKey && 86 === e.keyCode) || !pe.webkit || -1 === navigator.userAgent.indexOf('Version/'))) {
          if ((e.stopImmediatePropagation(), c.set(e), f.set(!0), pe.ie && u)) return e.preventDefault(), void s.fire('paste', { ieFake: !0 });
          v.remove(),
            v.create(),
            s.once('keyup', t),
      ...
      s.on('paste', function (e) {
        ...
        (u = !1),
          ...
          ((n = e.clipboardData), -1 !== navigator.userAgent.indexOf('Android') && n && n.items && 0 === n.items.length) ||
      ...
      o.parser.addNodeFilter('img', function (e, t, n) {
        ...
        if (!y(o) && n.data && !0 === n.data.paste)
          for (var a = e.length; a--; )
            (i = e[a].attr('src')) &&
              ((0 !== i.indexOf('webkit-fake-url') && (o.getParam('allow_html_data_urls', !1, 'boolean') || 0 !== i.indexOf('data:'))) ||
  ...
  r.add('paste', function (e) {
    if (
      ...
      return (
        ...
        (p = e).ui.registry.addToggleButton('pastetext', { active: !1, icon: 'paste-text', tooltip: 'Paste as text', onAction: x, onSetup: ae(p, (m = r)) }),
        p.ui.registry.addToggleMenuItem('pastetext', { text: 'Paste as text', icon: 'paste-text', onAction: x, onSetup: ae(p, m) }),
        (d = r),
