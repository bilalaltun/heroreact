...
!(function () {
  ...
  var t,
    ...
    a = function (e) {
      return (
        ...
        (null === r
          ? 'null'
          : 'object' == n && (Array.prototype.isPrototypeOf(r) || (r.constructor && 'Array' === r.constructor.name))
          ? 'array'
          : 'object' == n && (String.prototype.isPrototypeOf(r) || (r.constructor && 'String' === r.constructor.name))
          ? 'string'
          : n) === t
      );
      var r, n;
  ...
  function y() {
    ...
    for (var n = [], t = '', a = 0, i = e.length; a !== i; ++a) {
      ...
      16383 <= (o <= 65535 ? n.push(o) : ((o -= 65536), n.push(55296 + (o >> 10), (o % 1024) + 56320))) &&
      ...
      (function (e) {
        for (var r, n, t, a, i = 0, o = e.length; i < o; i++)
          (r = e[i]),
            ...
            (t = r[1]),
            (a = u),
            (d(y(n).toLowerCase(), a) || d(t.toLowerCase(), a) || d(t.toLowerCase().replace(/\s+/g, ''), a)) && c.push(r);
      })(e.characters),
      f(c, function (e) {
