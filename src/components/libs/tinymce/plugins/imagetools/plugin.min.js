...
!(function () {
  ...
  !(function () {
    ...
    'object' == typeof v && void 0 !== y ? (y.exports = t()) : ((e = 'undefined' != typeof globalThis ? globalThis : e || self).EphoxContactWrapper = t());
  })();
      ...
      return new I(function (e, t) {
        ...
        n.open('GET', r, !0),
          ...
          (n.onerror = function () {
            ...
            t(
              0 === this.status
                ? (((e = new Error('No access to download image')).code = 18), (e.name = 'SecurityError'), e)
  ...
  function z(e, t) {
    ...
    return F(((r = t), (o = -1 === (n = e).indexOf('?') ? '?' : '&'), /[?&]apiKey=/.test(n) ? n : n + o + 'apiKey=' + encodeURIComponent(r)), i).then(function (
      e
    ) {
      return H(e.status)
        ? ((t = e.status),
          'application/json' !== (null == (n = e.blob) ? void 0 : n.type) || (400 !== t && 403 !== t && 404 !== t && 500 !== t)
            ? B(t)
            : ((r = n),
              new I(function (e, t) {
    ...
    return s.toBlob().then(function (e) {
      ...
      return (
        u.getParam('images_reuse_filename', !1, 'boolean') &&
          (n = h((o = r.getByUri(i))) ? ((i = o.uri()), (t = o.name()), o.filename()) : ((t = ae(u, i, 2)), ae(u, i, 1))),
        (o = r.create({ id: 'imagetools' + we++, blob: e, base64: s.toBase64(), uri: i, name: t, filename: a ? n : void 0 })),
        r.add(o),
        ...
        re(s, t.dom).each(function (e) {
          ce(s, t.dom).then(function (e) {
            ...
            s.windowManager.open({
              title: 'Edit Image',
              size: 'large',
              body: { type: 'panel', items: [{ type: 'imagetools', name: 'imagetools', label: 'Edit Image', currentState: t }] },
              buttons: [
                            ...
                            (u.w === i.w && u.h === i.h) ||
                              (Y(a) &&
                                ...
                                (n = i) &&
                                  ((r = t.style.width),
                                  (o = t.style.height),
                                  (r || o) && ((t.style.width = n.w + 'px'), (t.style.height = n.h + 'px'), t.removeAttribute('data-mce-style')),
                                  (r = t.width),
                                  (o = t.height),
                                  (r || o) && (t.setAttribute('width', String(n.w)), t.setAttribute('height', String(n.h)))))),
                            URL.revokeObjectURL(e.src),
                            c
                          );
                        })
  ...
  function ge(t) {
    ...
    t.on('NodeChange', function () {
      ...
      t.ui.registry.addButton('rotateleft', { tooltip: 'Rotate counterclockwise', icon: 'rotate-left', onAction: n('mceImageRotateLeft'), onSetup: r }),
      t.ui.registry.addButton('rotateright', { tooltip: 'Rotate clockwise', icon: 'rotate-right', onAction: n('mceImageRotateRight'), onSetup: r }),
      t.ui.registry.addButton('flipv', { tooltip: 'Flip vertically', icon: 'flip-vertically', onAction: n('mceImageFlipVertical'), onSetup: r }),
      t.ui.registry.addButton('fliph', { tooltip: 'Flip horizontally', icon: 'flip-horizontally', onAction: n('mceImageFlipHorizontal'), onSetup: r }),
      t.ui.registry.addButton('editimage', { tooltip: 'Edit image', icon: 'edit-image', onAction: n('mceEditImage'), onSetup: r }),
      t.ui.registry.addButton('imageoptions', { tooltip: 'Image options', icon: 'image', onAction: n('mceImage') }),
