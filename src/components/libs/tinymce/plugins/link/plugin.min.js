  ...
  function V(l, c, f) {
    var t,
      ...
      g =
        ...
        (u = st({}, e)),
        0 < T(n).length || !1 !== P(n) || ((r = B(u.rel, '_blank' === u.target)), (u.rel = r || null)),
  ...
  function q(t, n, e) {
    ...
    t.hasPlugin('rtc', !0)
      ? t.execCommand(
          ...
          (m = g.title),
          R(
            { class: a.getOrNull(), href: l, rel: c.getOrNull(), target: f.getOrNull(), text: s.getOrNull(), title: m.getOrNull() },
            function (t, n) {
              return !1 === p(t);
            },
            ((i = u = {}),
        ...
        commands: [
          {
            ...
            onAction: function (t) {
              ...
              q(a, { href: n, attach: h }, { href: n, text: e, title: it.none(), rel: it.none(), target: it.none(), class: it.none() }),
