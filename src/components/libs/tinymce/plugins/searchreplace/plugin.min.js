...
!(function () {
        ...
        cef: function (e) {
          var t,
            ...
            a = w(
              ...
              (1 !== (o = i = void 0 === n ? document : n.dom).nodeType && 9 !== o.nodeType && 11 !== o.nodeType) || 0 === o.childElementCount
                ? []
    ...
    b(e, function (e, o) {
      b(e, function (e) {
        ...
        r.length === e.finish && 0 === e.start
          ? F(e.element, t)
          : (r.length !== e.finish && r.splitText(e.finish), (n = r.splitText(e.start)), F(fe.fromDom(n), t));
      });
    });
  }
  function K(e) {
  ...
  function ee(e, t, n, r, o, i) {
    ...
    return (
      ...
      d && ((u = Y(e, t, !0)), t.set({ index: u, count: d, text: n, matchCase: r, wholeWord: o, inSelection: i })),
      d
    );
  }
  function te(e, t) {
  ...
  function oe(e, t, n, r, o) {
    ...
    return t.set(v(v({}, a), { count: o ? 0 : a.count - 1, index: u })), (r ? te : ne)(e, t), !o && 0 < t.get().count;
  }
  function ie(i, a) {
    var e,
      t,
  ...
  o.add('searchreplace', function (e) {
    ...
    return (
      ...
      (n = e).ui.registry.addMenuItem('searchreplace', { text: 'Find and replace...', shortcut: 'Meta+F', onAction: ae(n, (r = a)), icon: 'search' }),
      n.ui.registry.addButton('searchreplace', { tooltip: 'Find and replace', onAction: ae(n, r), icon: 'search' }),
