...
!(function () {
    ...
    return function (e) {
      return (
        ...
        (null === n
          ...
          ? 'array'
          : 'object' == r && (String.prototype.isPrototypeOf(n) || (n.constructor && 'String' === n.constructor.name))
          ? 'string'
          : r) === t
      );
      var n, r;
  ...
  function V(e, n, r) {
    !(function (e, n, r) {
      if (!(l(r) || o(r) || i(r)))
        throw (console.error('Invalid call to Attribute.set. Key ', n, ':: Value ', r, ':: Element ', e), new Error('Attribute value was not simple'));
      e.setAttribute(n, r + '');
    })(e.dom, n, r);
  }
  function X(e, n) {
    ...
    !(function (e) {
      for (var n, r = R(e), t = 0, o = r.length; t < o; t++) {
        ...
        (n = e[i]),
          (function (e, n, r) {
            if (!l(r))
              throw (console.error('Invalid call to CSS.set. Property ', n, ':: Value ', r, ':: Element ', e), new Error('CSS value must be a string: ' + r));
  ...
  function ne(o, e, n) {
    ...
    var t,
      ...
      m =
        ((i = 'background-color'),
        (u = (t = n).dom),
        void 0 !== (a = '' !== (c = window.getComputedStyle(u).getPropertyValue(i)) || Pe(t) ? c : Me(u, i)) && '' !== a
  ...
  function oe(e) {
    ...
    var r = e.current,
      t = e.version;
    return { current: r, version: t, isEdge: n('Edge'), isChrome: n('Chrome'), isIE: n('IE'), isOpera: n('Opera'), isFirefox: n(pe), isSafari: n('Safari') };
  }
  function ie(e) {
    function n(e) {
      return function () {
  ...
  var ue,
    ...
    ge = {
      ...
      oses: y([
        ...
        { name: 'OSX', search: H('mac os x'), versionRegexes: [/.*?mac\ os\ x\ ?([0-9]+)_([0-9]+).*/] },
          ...
          u = Be.throttle(function () {
            (document.body.scrollTop = 0),
              ...
              window.requestAnimationFrame(function () {
                t.on(function (e) {
                  return z(e, { top: n.offsetTop + 'px', left: n.offsetLeft + 'px', height: n.height + 'px', width: n.width + 'px' });
                });
              });
          }, 50);
        return {
    ...
    Ke = function (o, i) {
      ...
      function e() {
        ...
        F &&
          ...
          (e = '[' + Ve + ']'),
          D(
            (1 !== (n = t = document).nodeType && 9 !== n.nodeType && 11 !== n.nodeType) || 0 === n.childElementCount
              ? []
        ...
        : ((n = $(
          ...
          (r = {
            scrollPos:
              ...
              (v = void 0 === l ? window : l),
              (g = v.document),
              (d = (m = void 0 !== (f = L.fromDom(g)) ? f.dom : document).body.scrollLeft || m.documentElement.scrollLeft),
  ...
  t.add('fullscreen', function (e) {
    ...
    return (
      e.inline ||
        ...
        t.ui.registry.addToggleButton('fullscreen', { tooltip: 'Fullscreen', icon: 'fullscreen', onAction: c, onSetup: re(t, o) }),
