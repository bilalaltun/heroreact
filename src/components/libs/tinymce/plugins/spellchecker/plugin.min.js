            ...
            (function (e, t, n) {
              ...
              e: for (;;) {
                if (
                  ...
                  if (
                    ((u = n({ startNode: r, startNodeIndex: a, endNode: o, endNodeIndex: i, innerNodes: s, match: c.text, matchIndex: d })),
                    (l -= o.length - i),
                    (o = r = null),
                    (s = []),
                    d++,
              ...
              function (e) {
                ...
                if (t === n) {
                  ...
                  return (
                    i.insertBefore(c, a),
                    e.endNodeIndex < a.length && ((l = o.createTextNode(a.data.substring(e.endNodeIndex))), i.insertBefore(l, a)),
