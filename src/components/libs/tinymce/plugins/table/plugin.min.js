...
!(function () {
  ...
  function le(e, n) {
    return He().browser.isIE()
      ? ((t = e.dom), (r = n.dom), (o = Node.DOCUMENT_POSITION_CONTAINED_BY), 0 != (t.compareDocumentPosition(r) & o))
  ...
  function Se(e) {
    ...
    var t = e.current,
      r = e.version;
    return { current: t, version: r, isEdge: n('Edge'), isChrome: n('Chrome'), isIE: n('IE'), isOpera: n('Opera'), isFirefox: n(Me), isSafari: n('Safari') };
  }
  function Te(e) {
    function n(e) {
      return function () {
  ...
  var Re,
    ...
    Be = {
      browsers: C([
        ...
        { name: 'Opera', versionRegexes: [Ie, /.*?opera\/([0-9]+)\.([0-9]+).*/], search: te('opera') },
        { name: 'Firefox', versionRegexes: [/.*?firefox\/\ ?([0-9]+)\.([0-9]+).*/], search: te('firefox') },
        {
          name: 'Safari',
      ...
      oses: C([
        { name: 'Windows', search: te('win'), versionRegexes: [/.*?windows\ nt\ ?([0-9]+)\.([0-9]+).*/] },
        {
          name: 'iOS',
          search: function (e) {
        ...
        { name: 'Android', search: te('android'), versionRegexes: [/.*?android\ ?([0-9]+)\.([0-9]+).*/] },
        { name: 'OSX', search: te('mac os x'), versionRegexes: [/.*?mac\ os\ x\ ?([0-9]+)_([0-9]+).*/] },
  ...
  function Bn(e, n, t) {
    if (!(T(t) || o(t) || f(t)))
      throw (console.error('Invalid call to Attribute.set. Key ', n, ':: Value ', t, ':: Element ', e), new Error('Attribute value was not simple'));
    e.setAttribute(n, t + '');
  }
  function Mn(e, n, t) {
    Bn(e.dom, n, t);
  ...
  function vt(e) {
    ...
    A(r.fail, function (e) {
      ...
      A(e.cells, function (e) {
        ...
        for (
          var t = be(a, n.toString()), r = { element: e.element, rowspan: e.rowspan, colspan: e.colspan, row: s, column: n, isLocked: t }, o = 0;
          o < e.colspan;
          o++
        )
  ...
  function Zt() {
    return {
      ...
      insert: C({ before: Rt, after: Dt, afterAll: kt, append: Xt, appendAll: It, prepend: Ot, wrap: At }),
    ...
    return ce(c, l)
      ...
      : nr(c).bind(function (i) {
          return nr(l).bind(function (u) {
            if (ce(i, u)) return q.some({ boxes: ((r = c), (o = l), St(Kt(i), r, o)), start: c, finish: l });
            if (le(i, u)) {
              ...
              Ct((n = u), r, o).bind(function (e) {
                return (function (e, n) {
                  for (var t = !0, r = P(yt, n), o = n.startRow; o <= n.finishRow; o++)
                    for (var u = n.startCol; u <= n.finishCol; u++) t = t && $t.getAt(e, o, u).exists(r);
  ...
  var _r,
    ...
    ro = function (e) {
      return dr()
        ? ((t = pr((n = e))), (o = (r = n.dom).getBoundingClientRect().height || r.offsetHeight), 'border-box' === t ? o : br(n, o, 'top', 'bottom'))
    ...
    so =
      ((jr = ['Infinity', (_r = '[0-9]+') + '\\.' + mo(_r) + mo((Wr = '[eE][+-]?[0-9]+')), '\\.' + _r + mo(Wr), _r + mo(Wr)].join('|')),
      new RegExp('^([+-]?(?:' + jr + '))(.*)$'));
  function mo(e) {
    return '(?:' + e + ')?';
  }
          ...
          for (var f = !1, s = 0; s < c; s++)
            a < t.minRow ||
              ...
              ($t.getAt(n, a, s).filter(r).isNone()
                ? ((o = f), 0, (u = e[a].element), (i = Ve.fromTag('td')), Xt(i, Ve.fromTag('br')), (o ? Xt : Ot)(u, i))
                : (f = !0));
      })(b, v, w, t),
      (o = p),
      (m = w),
  ...
  function Ko(e) {
    return { col: Ho(e), colgroup: Vo(e), row: qo(e), cell: Fo(e), replace: Go, colGap: Ho(e), gap: Fo(e) };
  }
  function Xo(e) {
      ...
      Lu(i, c, function (e, n) {
        var t,
          ...
          c =
            ...
            (o = n.y - e.top),
            (u = a),
            qn((i = Ve.fromTag('div')), { position: 'absolute', left: r + 'px', top: o - 3.5 + 'px', height: '7px', width: u + 'px' }),
      ...
      Lu(v, w, function (e, n) {
        var t,
          ...
          c =
            ...
            (o = y.top - e.top),
            (u = C),
            qn((i = Ve.fromTag('div')), { position: 'absolute', left: r - 3.5 + 'px', top: o + 'px', height: u + 'px', width: '7px' }),
  ...
  function Vu(o) {
    ...
    var g = Au(o.parent(), 'mousedown', function (e) {
      ...
      b = Su({ adjustHeight: Cu(['table', 'delta', 'row']), adjustWidth: Cu(['table', 'delta', 'column']), startAdjust: Cu([]) });
    return {
      destroy: function () {
    ...
    return (
      p.on('init', function () {
        var e,
          ...
          g =
            ...
            (e = p).inline
              ? ((u = Yo(e)),
                qn((c = Ve.fromTag('div')), { position: 'static', height: '0', width: '0', padding: '0', margin: '0', border: '0' }),
        ...
        (y = q.some(g)),
          ...
          (T(o) ? 'table' === o : o) &&
            ...
            (f = ao),
            (s = Vu(g)),
            (d = Su({ beforeResize: Cu(['table', 'type']), afterResize: Cu(['table', 'type']), startDrag: Cu([]) })),
            ...
            (r = { on: s.on, off: s.off, hideBars: s.hideBars, showBars: s.showBars, destroy: s.destroy, events: d.registry }).on(),
      ...
      p.on('ObjectResizeStart', function (e) {
        ...
        m(u) &&
          ...
          (d = e.width),
          (g = Ia(p) ? '' : ((o = (t = p).dom.getStyle((r = u), 'width') || t.dom.getAttrib(r, 'width')), q.from(o).filter(ne).getOr(''))));
      }),
      p.on('ObjectResized', function (e) {
        ...
        m(s) &&
          ...
          Ae(t, 'corner-') &&
            ...
            '' === g && Ba(r),
            o !== d && '' !== g
              ? (Vn(r, 'width', g), (u = h()), (i = b(r)), (c = li(p) || f ? yu(r).columns - 1 : 0), au(r, o - d, c, u, i))
              : /^(\d+(\.\d+)?)%$/.test(g) && Vn(r, 'width', (o * parseFloat(g.replace('%', ''))) / d + '%'),
            /^(\d+(\.\d+)?)px$/.test(g) &&
              ((a = $t.fromTable((l = r))),
              $t.hasColumns(a) ||
                A(nt(l), function (e) {
  ...
  function yc(e, n, t) {
    var r,
      ...
      l =
        ...
        (c = gt(e).rows),
        q
          .from(null === (i = null === (u = c[r]) || void 0 === u ? void 0 : u.cells[o]) || void 0 === i ? void 0 : i.element)
          .filter(hc)
          .orThunk(function () {
  ...
  function zc(u, i, c, l, a) {
    var o = Qu(u),
      f = { styles: o, attributes: Ju(u), colGroups: u.getParam('table_use_colgroups', !1, 'boolean') };
    return (
      ...
      kn(Yo(u), 'table[data-mce-id="__mce"]')
        .map(function (e) {
          var n, t, r;
          return (
            ka(u) ? Ma(e) : Ia(u) ? Ea(e) : (ui(u) || ((n = o.width), T(n) && -1 !== n.indexOf('%'))) && Ba(e),
            nu(e),
            Wt(e, 'data-mce-id'),
            (t = u),
  ...
  function qc(e) {
    return Of.test((t = e)) || Af.test(t) ? q.some({ value: (Ae((n = e), '#') ? n.substring('#'.length) : n).toUpperCase() }) : q.none();
    var n, t;
  }
  function Uc(e) {
    var n = e.toString(16);
  ...
  function ol(e) {
    return Pf.concat((0 < (n = Bf(ri(e))).length ? q.some({ name: 'class', type: 'listbox', label: 'Class', items: n }) : q.none()).toArray());
    var n;
  }
  function ul(e, n) {
    var t = [
      { name: 'borderstyle', type: 'listbox', label: 'Border style', items: [{ text: 'Select...', value: '' }].concat(Bf(Yu(e))) },
  ...
  function dl(e, n) {
    ...
    0 !== i.length &&
      ...
      (o = { type: 'tabpanel', tabs: [{ title: 'General', name: 'general', items: ol(e) }, ul(e, 'cell')] }),
  ...
  function bl(i) {
    ...
    0 !== l.length &&
      ...
      (u = { type: 'tabpanel', tabs: [{ title: 'General', name: 'general', items: gl(i) }, ul(i, 'row')] }),
  ...
  function hl(u, i, t, e) {
    ...
    e.close(),
      ...
      u.undoManager.transact(function () {
        var e, n, t, r, o;
        i || ((e = parseInt(l.cols, 10) || 1), (n = parseInt(l.rows, 10) || 1), (i = zc(u, e, n, 0, 0))),
          0 < ge(a) &&
            ((function (e, n, t) {
              var r,
                o = e.dom,
              ...
              if (
                ...
                ti(e)
                  ...
                  : ((u.border = t.border), (u.cellpadding = t.cellpadding), (u.cellspacing = t.cellspacing)),
                ti(e) && n.children)
              )
              ...
              ni(e) && ((i['background-color'] = t.backgroundcolor), (i['border-color'] = t.bordercolor), (i['border-style'] = t.borderstyle)),
          ...
          u.focus(),
          u.addVisual(),
          0 < ge(a) && ((o = !(r = Ke(a, 'caption')) || 1 < ge(a)), Gu(u, i, { structure: r, style: o }));
      });
  }
  function vl(e, n) {
    var t,
      ...
      S =
        ...
        K(
          K(
            K(K(K(K({}, { height: '', width: '100%', cellspacing: '', cellpadding: '', caption: !1, class: '', align: '', border: '' }), a), f), s),
            ((l = a['border-width']),
            ti(r) && l
              ? { border: l }
              : pe(f, 'border').fold(
    ...
    var x,
      ...
      k = ni(e) ? { type: 'tabpanel', tabs: [{ title: 'General', name: 'general', items: [A] }, ul(e, 'table')] } : { type: 'panel', items: [A] };
    e.windowManager.open({
  ...
  function yl(l, n, e, a, t) {
      ...
      return f(function (e, n) {
        ...
        return (
          ...
          _i((o = $t.fromTable(e)), t)
            .bind(function (e) {
              var n = Ei(
                N(gt(Mi(o, r, !1)).rows.slice(e[0].row, e[e.length - 1].row + e[e.length - 1].rowspan), function (e) {
    ...
    ae(
              ...
              .each(function (e) {
                ...
                Dt(e, t),
                  ...
                  l.dom.isEmpty(l.getBody())
                    ...
                    : ((n = l.dom.createRng()).setStart(t.dom, 0), n.setEnd(t.dom, 0), l.selection.setRng(n), l.nodeChanged());
              });
          });
        },
      ...
      ae({ mceTableProps: P(vl, l, !1), mceTableRowProps: P(bl, l), mceTableCellProps: P(dl, l, a) }, function (e, n) {
      ...
      l.addCommand('mceInsertTable', function (e, n) {
        g(n) && 0 < Ue(n).length
          ? Lc(l, n.rows, n.columns, n.options, 'Invalid values for mceInsertTable - rows and columns values are required to insert a table.')
          : vl(l, !0);
      }),
  ...
  function Il(e, n) {
    return { parent: C(q.from(e.dom.documentElement).map(Ve.fromDom).getOr(e)), view: C(e), origin: C(uo(0, 0)), isResizable: n };
  }
  function Bl(e) {
  ...
  var _l = /(\d+(\.\d+)?)%/,
    ...
    Jl = uu('th,td'),
    Ql = ru,
    Zl = Lr([{ none: [] }, { only: ['index'] }, { left: ['index', 'next'] }, { middle: ['prev', 'index', 'next'] }, { right: ['prev', 'index'] }]),
    ea = K({}, Zl),
    na = mu(function (e) {
      return e < 0;
    }),
    ...
    xf = { styles: { 'border-collapse': 'collapse', width: '100%' }, attributes: { border: '1' }, colGroups: !1 },
                ...
                function (t) {
                  function e() {
                    ...
                    o
                      ...
                      : (t.setActive(z(n, e)), r.set(u.formatter.formatChanged(c, t.setActive, !1, { value: l })));
                  }
                  var r = Yc(function (e) {
                      return e.unbind();
                    }),
    ...
    Vf = Lr([{ none: ['current'] }, { first: ['current'] }, { middle: ['current', 'target'] }, { last: ['current'] }]),
    qf = K(K({}, Vf), {
      none: function (e) {
    ...
    Xf = Lr([{ domRange: ['rng'] }, { relative: ['startSitu', 'finishSitu'] }, { exact: ['start', 'soffset', 'finish', 'foffset'] }]),
    Yf = {
    ...
    Qf = Lr([{ ltr: ['start', 'soffset', 'finish', 'foffset'] }, { rtl: ['start', 'soffset', 'finish', 'foffset'] }]);
  function Zf(e, n, t) {
  ...
  function Es(e, n, t) {
    return gn(n)
      ? Ms(e, n).map(Bs)
      : pn(n)
      ? ((r = e), (o = n), (0 <= (u = t) && u < Lo(o) ? r.getRangedRect(o, u, o, u + 1) : 0 < u ? r.getRangedRect(o, u - 1, o, u) : q.none()).map(Bs))
      : q.none();
    var r, o, u;
  }
  function Ps(e, n) {
  ...
  function zs(n, t, e) {
    var r,
      ...
      i = u,
      c = t;
    return ((r = n).point(i) > c.getInnerHeight() ? q.some(r.point(i) - c.getInnerHeight()) : r.point(i) < 0 ? q.some(-r.point(i)) : q.none()).fold(
      function () {
    ...
    return {
      ...
      getRangedRect: function (e, n, t, r) {
        var o,
          ...
          c = Yf.exact(e, n, t, r);
        return (
          (i = (o = kl(l, c)).getClientRects()), 0 < (u = 0 < i.length ? i[0] : o.getBoundingClientRect()).width || 0 < u.height ? q.some(u).map(Dl) : q.none()
        );
      },
  ...
  var Ys = function (e, n, t, r) {
    ...
    xm = { traverse: cn, gather: xs, relative: Kf.before, otherRetry: wm.tryDown, ieRetry: wm.ieTryDown, failure: dm.failedDown },
    Rm = { traverse: un, gather: Ts, relative: Kf.before, otherRetry: wm.tryUp, ieRetry: wm.ieTryUp, failure: dm.failedUp },
    Dm = Vs(38),
    Om = Vs(40),
              ...
              Hs(i.target, f).each(function (u) {
                tr(e, u, f).each(function (e) {
                  var n,
                    ...
                    o = e.boxes.getOr([]);
                  1 === o.length
                    ? ((n = o[0]), (t = 'false' === pa(n)), (r = Ln(Pu(i.target), n, ce)), t && r && (s.selectRange(l, o, n, n), c.selectContents(n)))
          ...
          k =
            ...
            (A = Xc(0)),
            {
              touchEnd: function (e) {
                ...
                ('td' !== Ye(r) && 'th' !== Ye(r)) || ((n = O.get()), (t = A.get()), ce(n, r) && e.timeStamp - t < 300 && (e.preventDefault(), S(r, r))),
                  O.set(r),
                  A.set(e.timeStamp);
              },
            });
    ...
    function e() {
      return Yl(tu(o), Zo(o)).bind(function (r) {
        return Wn(rt(r), Yl(Ve.fromDom(o.selection.getEnd()), Zo(o)).bind(rt), function (e, n) {
          return ce(e, n) ? (g(r) ? q.some({ element: (t = r), mergable: q.none(), unmergable: q.none(), selection: [t] }) : q.some(ou(u, e, r))) : q.none();
          var t;
        }).bind(S);
      });
    }
