...
!(function () {
  ...
  function ae(r, e) {
    var t = (function (e) {
      ...
      if (
        ...
        return n.appendChild(t), n.appendChild(Ue.create('figcaption', { contentEditable: 'true' }, 'Caption')), (n.contentEditable = 'false'), n;
      }
      return t;
    })(e);
          ...
          ? ((m = i),
            ...
            Z(h.parentNode)
              ...
              : (u.selection.select(h),
                ...
                (p = m),
                ((f = h).onload = function () {
                  p.width || p.height || !C(g) || g.dom.setAttribs(f, { width: String(f.clientWidth), height: String(f.clientHeight) }), y();
                }),
                (f.onerror = y)))
          : ((a = t),
            (o = b) &&
  ...
  function ce(e) {
    ...
    return S([
      ...
      [
        v(v({}, e.classList.isSome() && e.hasImageCaption ? { type: 'grid', columns: 2 } : { type: 'panel' }), {
          items: S([
            r.toArray(),
            e.hasImageCaption ? [{ type: 'label', label: 'Caption', items: [{ type: 'checkbox', name: 'caption', label: 'Show caption' }] }] : [],
          ]),
        }),
      ],
    ]);
            ...
            .then(
              ...
              function (e) {
                var t,
                  n,
                  r,
                  i = { prevImage: Ee((t = e).imageList, t.image.src), prevAlt: t.image.alt, open: !0 };
                return {
  ...
  var ye,
    ...
    Ie = function (e, t, n) {
      n
        ...
        : (i === t ? ve(e).dom.removeAttribute('alt') : I(ve(e), 'alt', t), 'presentation' === Ue.getAttrib(e, 'role') && Ue.setAttrib(e, 'role', ''));
    },
    Ce = function (e, t, n) {
      var r = Y(e, n);
    ...
    Ne = function (e, a) {
      ...
      return (
        Te.each(e, function (e) {
          ...
          void 0 !== e.menu ? ((n = Ne(e.menu, a)), o.push({ text: i, items: n })) : ((r = a(e)), o.push({ text: i, value: r }));
        }),
        o
      );
    },
  ...
  o.add('image', function (e) {
    ...
    (t = e).on('PreInit', function () {
      ...
      (n = e).ui.registry.addToggleButton('image', {
        ...
        onSetup: function (e) {
          return (
            e.setActive(D(re(n))), n.selection.selectorChangedWithUnbind('img:not([data-mce-object],[data-mce-placeholder]),figure.image', e.setActive).unbind
          );
        },
      }),
