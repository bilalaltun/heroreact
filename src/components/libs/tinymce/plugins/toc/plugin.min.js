    ...
    (c = t).addCommand('mceInsertToc', function () {
      ...
      (o = a((t = c))),
        ...
        !i.length || 0 < r.dom.getParents(i[0], '.mce-offscreen-selection').length
          ? t.insertContent(((n = d((e = t))), '<div class="' + e.dom.encode(a(e)) + '" contenteditable="false">' + n + '</div>'))
          : f(t);
    }),
      c.addCommand('mceUpdateToc', function () {
        f(c);
      }),
      (i = t).ui.registry.addButton('toc', { icon: 'toc', tooltip: 'Table of contents', onAction: l, onSetup: u(i) }),
      ...
      i.ui.registry.addMenuItem('toc', { icon: 'toc', text: 'Table of contents', onAction: l, onSetup: u(i) }),
