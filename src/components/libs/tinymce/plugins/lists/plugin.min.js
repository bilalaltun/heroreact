...
!(function () {
  ...
  function He(e, t) {
    ...
    if (
      (c &&
        ((o = a.create(c)).tagName === c.toUpperCase() && a.setAttribs(o, e.getParam('forced_root_block_attrs', {})), _e(t.firstChild, s) || u.appendChild(o)),
      t)
    )
      for (; (r = t.firstChild); ) {
        var f = r.nodeName;
        i || ('SPAN' === f && 'bookmark' === r.getAttribute('data-mce-type')) || (i = !0),
          _e(r, s) ? (u.appendChild(r), (o = null)) : c ? (o || ((o = a.create(c)), u.appendChild(o)), o.appendChild(r)) : u.appendChild(r);
      }
    ...
    var r,
      o = (function (e, t, n) {
        for (var r, o, i, a = [], s = 0; s < n; s++)
          a.push(((o = t.listType), we((i = { list: me.fromTag(o, (r = e)), item: me.fromTag('li', r) }).list, i.item), i));
        return a;
  ...
  function gt(o) {
    function e(e) {
      ...
      1 === n.nodeType &&
        ...
        n.hasChildNodes()
          ? ((r = Math.min(r, n.childNodes.length - 1)), e ? n.insertBefore(t, n.childNodes[r]) : Gt.insertAfter(t, n.childNodes[r]))
          : n.appendChild(t),
        (n = t),
        (r = 0)),
  ...
  function Nt(e, t, n, r) {
    ...
    for (
      1 === o.nodeType && (o = o.childNodes[Math.min(i, o.childNodes.length - 1)] || o), !n && Kt(o.nextSibling) && (o = o.nextSibling);
      o.parentNode !== r;
    ...
    'false' !== l.getContentEditable(u.selection.getNode()) &&
        ...
        return (
          Mt.each(u, function (e) {
            ...
            Zt.isBookmarkNode(e) && (Ut(t) || Ue(n, t) || (!t && e.parentNode === r))
              ? (o = null)
              : (o || ((o = a.create('p')), e.parentNode.insertBefore(o, e), i.push(o)), o.appendChild(e));
          }),
          i
        );
      })(u, n, r)),
      Mt.each(t, function (e) {
        var t,
          ...
          s = e.parentNode;
        Ft(s) ||
          (a && Ut(a) && a.nodeName === c && ((o = f), l.getStyle(a, 'list-style-type') === (i = null === (i = o ? o['list-style-type'] : '') ? '' : i))
            ? ((t = a), (e = l.rename(e, d)), a.appendChild(e))
            : ((t = l.create(c)), e.parentNode.insertBefore(t, e), t.appendChild(e), (e = l.rename(e, d))),
          (n = l),
          (r = e),
          Mt.each(
            [
  ...
  function Lt(e, t, n) {
    return (
      ...
      (i = t) &&
        ...
        ((o = n), (r = e).getStyle(t, 'list-style-type', !0) === r.getStyle(o, 'list-style-type', !0)) &&
          ...
          c.undoManager.transact(function () {
            ...
            f
              ? ((t = l),
                ...
                (r = d),
                (u = (e = c).dom).isEmpty(r)
                  ? ((a = n), (i = e).dom.$((s = r)).empty(), At(i.dom, a, s), i.selection.setCursorLocation(s, 0))
            ...
            n.execCommand('Delete'),
              ...
              Mt.each(t, function (e) {
                ...
                'LI' === (r = (t = e).parentNode).nodeName &&
                  r.firstChild === t &&
                  ((n = r.previousSibling) && 'LI' === n.nodeName ? (n.appendChild(t), $e(o, r) && tn.remove(r)) : tn.setStyle(r, 'listStyleType', 'none')),
      ...
      (r = Qe((t = o))),
        $t(r) &&
          t.windowManager.open({
            ...
            initialData: {
              start:
                ((e = { start: t.dom.getAttrib(r, 'start', '1'), listStyleType: E.some(t.dom.getStyle(r, 'list-style-type')) }),
                (n = parseInt(e.start, 10)),
                ze(e.listStyleType, 'upper-alpha') ? nn(n) : ze(e.listStyleType, 'lower-alpha') ? nn(n).toLowerCase() : e.start),
            },
            buttons: [
