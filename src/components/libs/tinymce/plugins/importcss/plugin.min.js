  ...
  function h(t, e) {
    ...
    if (n) {
      ...
      return (
        n[1]
          ? ((r = { title: e }),
            t.schema.getTextBlockElements()[o] ? (r.block = o) : t.schema.getBlockElements()[o] || c[o.toLowerCase()] ? (r.selector = o) : (r.inline = o))
          : n[2] && (r = { inline: 'span', title: e.substr(1), classes: i }),
        !1 !== t.getParam('importcss_merge_classes') ? (r.classes = i) : (r.attributes = { class: i }),
        r
      );
    }
  }
