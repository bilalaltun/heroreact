  ...
  function d(e, t, n) {
    return (
      ...
      (t = (t = (t = (t = (t = (t = (t = (t = (t = (t = (t = (t = (t = (t = (t = t.replace('%D', '%m/%d/%Y')).replace('%r', '%I:%M:%S %p')).replace(
        '%Y',
        '' + n.getFullYear()
      )).replace('%y', '' + n.getYear())).replace('%m', r(n.getMonth() + 1, 2))).replace('%d', r(n.getDate(), 2))).replace(
        '%H',
        '' + r(n.getHours(), 2)
      )).replace('%M', '' + r(n.getMinutes(), 2))).replace('%S', '' + r(n.getSeconds(), 2))).replace('%I', '' + (((n.getHours() + 11) % 12) + 1))).replace(
        '%p',
        n.getHours() < 12 ? 'AM' : 'PM'
