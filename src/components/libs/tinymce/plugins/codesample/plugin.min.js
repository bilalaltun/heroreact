...
!(function () {
  ...
  !(function (e, n) {
    ...
    (window.Prism = { manual: !0 }),
      ...
      (a = function () {
        ...
        return (
          ...
          (n = (function (u) {
              ...
              j = {
                ...
                highlightElement: function (e, n, t) {
                  ...
                  if (
                    ...
                    (s = o.element.parentElement) && 'pre' === s.nodeName.toLowerCase() && !s.hasAttribute('tabindex') && s.setAttribute('tabindex', '0'),
                    !o.code)
                  )
                          ...
                          for (var l = a[o], l = Array.isArray(l) ? l : [l], u = 0; u < l.length; ++u) {
                            ...
                            for (var f = d.pattern || d, h = r.next, y = s; h !== t.tail && !(i && y >= i.reach); y += h.value.length, h = h.next) {
                              ...
                              if (!(w instanceof T)) {
                                ...
                                $ && O(t, h, $),
                                  1 < v && (e(n, t, a, h.prev, y, (C = { cause: o + ',' + u, reach: z })), i && C.reach > i.reach && (i.reach = C.reach));
                              }
                            }
                          }
                    })(e, r, n, r.head, 0),
            ...
            return (
              r && ((j.filename = r.src), r.hasAttribute('data-manual') && (j.manual = !0)),
              j.manual ||
                ('loading' === (a = document.readyState) || ('interactive' === a && r && r.defer)
                      ...
                      'string' == typeof p || (p.content && 'string' == typeof p.content)
                        ? ((a = f[m]),
                          ...
                          -1 < (o = s.indexOf(i)) &&
                            ...
                            'string' == typeof p ? n.splice.apply(n, [t, 1].concat(d)) : (p.content = d)))
          ...
          (function (t) {
            ...
            (t.languages.csharp = t.languages.extend('clike', {
              string: [
                ...
                { pattern: r(/(^|[^@$\\])<<0>>/.source, [S]), lookbehind: !0, greedy: !0 },
              ],
              'class-name': [
                { pattern: r(/(\busing\s+static\s+)<<0>>(?=\s*;)/.source, [h]), lookbehind: !0, inside: _ },
                { pattern: r(/(\busing\s+<<0>>\s*=\s*)<<1>>(?=\s*;)/.source, [m, x]), lookbehind: !0, inside: _ },
                { pattern: r(/(\busing\s+)<<0>>(?=\s*=)/.source, [m]), lookbehind: !0 },
                { pattern: r(/(\b<<0>>\s+)<<1>>/.source, [u, f]), lookbehind: !0, inside: _ },
                { pattern: r(/(\bcatch\s*\(\s*)<<0>>/.source, [h]), lookbehind: !0, inside: _ },
                { pattern: r(/(\bwhere\s+)<<0>>/.source, [m]), lookbehind: !0 },
                { pattern: r(/(\b(?:is(?:\s+not)?|as)\s+)<<0>>/.source, [w]), lookbehind: !0, inside: _ },
                { pattern: r(/\b<<0>>(?=\s+(?!<<1>>|with\s*\{)<<2>>(?:\s*[=,;:{)\]]|\s+(?:in|when)\b))/.source, [x, p, m]), inside: _ },
              ],
              keyword: c,
              number:
              ...
              t.languages.insertBefore('csharp', 'punctuation', {
                'named-parameter': { pattern: r(/([(,]\s*)<<0>>(?=\s*:)/.source, [m]), lookbehind: !0, alias: 'punctuation' },
              }),
              t.languages.insertBefore('csharp', 'class-name', {
                ...
                'return-type': { pattern: r(/<<0>>(?=\s+(?:<<1>>\s*(?:=>|[({]|\.\s*this\s*\[)|this\s*\[))/.source, [x, h]), inside: _, alias: 'class-name' },
                'constructor-invocation': { pattern: r(/(\bnew\s+)<<0>>(?=\s*[[({])/.source, [x]), lookbehind: !0, inside: _, alias: 'class-name' },
                'generic-method': {
                  pattern: r(/<<0>>\s*<<1>>(?=\s*\()/.source, [m, g]),
                  inside: { function: r(/^<<0>>/.source, [m]), generic: { pattern: RegExp(g), alias: 'class-name', inside: _ } },
                },
                'type-list': {
                  pattern: r(
                  ...
                  lookbehind: !0,
                  inside: {
                    'record-arguments': { pattern: r(/(^(?!new\s*\()<<0>>\s*)<<1>>/.source, [f, b]), lookbehind: !0, greedy: !0, inside: t.languages.csharp },
                    keyword: c,
            ...
            t.languages.insertBefore('csharp', 'class-name', {
              attribute: {
                ...
                inside: {
                  ...
                  'attribute-arguments': { pattern: r(/\(<<0>>*\)/.source, [$]), inside: t.languages.csharp },
            ...
            function R(e, n) {
              return {
                interpolation: {
                  ...
                  lookbehind: !0,
                  inside: {
                    'format-string': { pattern: r(/(^\{(?:(?![}:])<<0>>)*)<<1>>(?=\}$)/.source, [n, C]), lookbehind: !0, inside: { punctuation: /^:/ } },
                    punctuation: /^\{|\}$/,
                    expression: { pattern: /[\s\S]+/, alias: 'language-csharp', inside: t.languages.csharp },
                  },
                },
                string: /[\s\S]+/,
              };
            ...
            t.languages.insertBefore('csharp', 'string', {
              'interpolation-string': [
                { pattern: r(/(^|[^\\])(?:\$@|@\$)"(?:""|\\[\s\S]|\{\{|<<0>>|[^\\{"])*"/.source, [T]), lookbehind: !0, greedy: !0, inside: R(T, j) },
                { pattern: r(/(^|[^@\\])\$"(?:\\.|\{\{|<<0>>|[^\\"{])*"/.source, [O]), lookbehind: !0, greedy: !0, inside: R(O, B) },
              ],
            ...
            import: [
              {
                ...
                lookbehind: !0,
                inside: { namespace: l.inside.namespace, punctuation: /\./, operator: /\*/, 'class-name': /\w+/ },
              },
              {
                pattern: RegExp(/(\bimport\s+static\s+)/.source + o + /(?:\w+|\*)(?=\s*;)/.source),
                lookbehind: !0,
                alias: 'static',
                inside: { namespace: l.inside.namespace, static: /\b\w+$/, punctuation: /\./, operator: /\*/, 'class-name': /\w+/ },
              },
            ],
            namespace: {
              pattern: RegExp(
          ...
          Object.defineProperty(Prism.languages.markup.tag, 'addInlined', {
            value: function (e, n) {
              var t = {};
              (t['language-' + n] = { pattern: /(^<!\[CDATA\[)[\s\S]+?(?=\]\]>$)/i, lookbehind: !0, inside: Prism.languages[n] }),
                (t.cdata = /^<!\[CDATA\[|\]\]>$/i);
              ...
              Prism.languages.markup.tag.inside['special-attr'].push({
                ...
                inside: {
                  ...
                  'attr-value': {
                    pattern: /=[\s\S]+/,
                    inside: {
                      value: { pattern: /(^=\s*(["']|(?!["'])))\S[\s\S]*(?=\2$)/, lookbehind: !0, alias: [n, 'language-' + n], inside: Prism.languages[n] },
      ...
      'object' == typeof e && void 0 !== n ? (n.exports = a()) : ((t = 'undefined' != typeof globalThis ? globalThis : t || self).EphoxContactWrapper = a());
    window.Prism;
    window.Prism = r;
  })(b, m);
