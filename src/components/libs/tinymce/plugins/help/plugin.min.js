...
!(function () {
          ...
          html: [
            null == e
              ...
              : '<div data-mce-tabstop="1" tabindex="-1">' +
                  ...
                  function (e) {
                    return (
                      ...
                      (function (e, t, n) {
                        ...
                        function (e) {
                          return a({ name: 'premium' === e.type ? e.name + '*' : e.name, url: 'https://www.tiny.cloud/docs/plugins/' + e.type + '/' + e.slug });
                        }
                      )) +
                      '</li>'
                    );
                ...
                (l = s.length),
                (c = s.join('')),
                '<p><b>' + T.translate(['Plugins installed ({0}):', l]) + '</b></p><ul>' + c + '</ul>') +
                '</div>',
            ((t = b(
              m(d, function (e) {
                var t = e.key,
    ...
    return function () {
      var e,
        ...
        m =
          ...
          (u = g((((n = {})[r.name] = r), (n[s.name] = s), (n[l.name] = l), (n[c.name] = c), n), t.get())),
  ...
  n.add('help', function (e) {
    ...
    return (
      ...
      a.ui.registry.addMenuItem('help', { text: 'Help', icon: 'help', shortcut: 'Alt+0', onAction: s }),
