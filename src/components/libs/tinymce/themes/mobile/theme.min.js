...
!(function () {
  ...
  var ln,
    ...
    wn = {
      browsers: w([
        ...
        { name: 'Firefox', versionRegexes: [/.*?firefox\/\ ?([0-9]+)\.([0-9]+).*/], search: $('firefox') },
        {
          name: 'Safari',
      ...
      oses: w([
        { name: 'Windows', search: $('win'), versionRegexes: [/.*?windows\ nt\ ?([0-9]+)\.([0-9]+).*/] },
        {
          name: 'iOS',
          search: function (n) {
        ...
        { name: 'Android', search: $('android'), versionRegexes: [/.*?android\ ?([0-9]+)\.([0-9]+).*/] },
        { name: 'OSX', search: $('mac os x'), versionRegexes: [/.*?mac\ os\ x\ ?([0-9]+)_([0-9]+).*/] },
    ...
    fe = {
      fromHtml: function (n, e) {
        ...
        if (((t.innerHTML = n), !t.hasChildNodes() || 1 < t.childNodes.length))
          throw (console.error('HTML does not have a single root node', n), new Error('HTML must have a single root node'));
  ...
  function Fe(n, e, t) {
    if (!(r(t) || d(t) || g(t)))
      throw (console.error('Invalid call to Attribute.set. Key ', e, ':: Value ', t, ':: Element ', n), new Error('Attribute value was not simple'));
    n.setAttribute(e, t + '');
  }
  function Ie(n, e, t) {
    Fe(n.dom, e, t);
  ...
  var ni = w(lo(Sr())),
    ...
    ti = Ao({ fields: [$t('channels', Nt(ht.value, It([Cr('onReceive'), Yt('schema', mo())])))], name: 'receiving', active: pr }),
    oi = Object.freeze({
      __proto__: null,
      onLoad: Br,
      toggle: Fr,
    ...
    fi = Ao({ fields: [kr('onFocus'), Yt('stopMousedown', !1), Yt('ignore', !1)], name: 'focusing', active: si, apis: ai }),
    li = function (n, e) {
  ...
  var Pi,
    ...
    Qi = Ao({ fields: [Lt('highlightClass'), Lt('itemClass'), kr('onHighlight'), kr('onDehighlight')], name: 'highlighting', apis: Ji });
      ...
      ((qu = jt(
        (tc = zt(
          'Creating behaviour: ' +
            (Xu = {
              branchKey: 'mode',
              branches: Object.freeze({ __proto__: null, acyclic: Ic, cyclic: Vc, flow: Bc, flatgrid: Ac, matrix: Nc, execution: Hc, menu: Pc, special: zc }),
              name: 'keying',
              active: {
                events: function (n, e) {
    ...
    return zt(
      ...
      It(
        ...
        (0 < o.length ? [Gt('parts', o)] : [])
          .concat([Lt('uid'), Yt('dom', {}), Yt('components', []), Mr('originalSpec'), Yt('debug.sketcher', {})])
          .concat(i)).concat(e)
      ),
      t
    );
  ...
  function ks(r) {
    return function (n, e) {
      return Ss(n, { x: (o = (0 < r ? ss : as)(is((t = e)).x, Na(t), ja(t), Ka(t))) }), mn.some(o).map(x);
      var t, o;
    };
  }
  ...
  function Ds(r) {
    return function (n, e) {
      return Cs(n, { y: (o = (0 < r ? ss : as)(is((t = e)).y, Ha(t), La(t), Ka(t))) }), mn.some(o).map(x);
      var t, o;
    };
  }
  ...
  function Fs(u, c) {
    return function (n, e) {
      return (
        (o = e),
        (r = 0 < u ? ss : as),
        _s(n, Rs((i = (t = c) ? is(o).x : r(is(o).x, Na(o), ja(o), Ka(o))), t ? r(is(o).y, Ha(o), La(o), Ka(o)) : is(o).y)),
        mn.some(i).map(x)
      );
      var t, o, r, i;
    };
        ...
        return [
          ...
          $f.sketch({
            ...
            components: [
              ...
              $f.parts.thumb({ dom: Oa('<div class="${prefix}-slider-thumb"></div>'), behaviours: or([ii.config({ toggleClass: ci('thumb-active') })]) }),
            ],
            onChange: function (n, e, t) {
              var o = i(t.x());
  ...
  function As(n) {
    return [
      ...
      ((e = { onChange: n.onChange, sizes: Xf, category: 'font', getInitialValue: n.getInitialValue }),
    ...
    Qs = wa({
      ...
      factory: function (n) {
        ...
        return {
          ...
          events: o,
          behaviours: $c(n.buttonBehaviours, [fi.config({}), jc.config({ mode: 'execution', useSpace: !0, useEnter: !0 })]),
          domModification: {
            attributes: (function () {
  ...
  function rl(n, e) {
    var t = Ns(
        rd.sketch({
          ...
          inputBehaviours: or([ed.config({ find: mn.some }), ud.config({}), jc.config({ mode: 'execution' })]),
          selectOnFocus: !1,
        })
      ),
      o = Ns(
            ...
            var e =
              ((t = function (n, e) {
                var t = n[c],
                  ...
                  i = a.indexOf(o);
                if (-1 === r)
                  throw new Error('The ordering for ' + u + ' does not have an entry for ' + t + '.\nOrder specified: ' + JSON.stringify(a, null, 2));
                if (-1 === i)
    ...
    var o,
      ...
      c =
        0 < e.length
          ...
          : u;
    return y(y({}, (r = i)), { attributes: y(y({}, r.attributes), c.attributes), styles: y(y({}, r.styles), c.styles), classes: r.classes.concat(c.classes) });
  }
  function yl(n, e, t) {
    var o,
      r,
        ...
        Ve(c, n.attributes),
          ...
          n.innerHtml.each(function (n) {
            return (
              (t = n),
              (i = me((e = c)).dom),
              xe((u = fe.fromDom(i.createDocumentFragment())), ((o = t), ((r = (i || document).createElement('div')).innerHTML = o), Je(fe.fromDom(r)))),
              we(e),
              void Qe(e, u)
            );
            var e, t, o, r, i, u;
  ...
  function Sl(n) {
    (jo(n.element).isNone() || fi.isFocused(n)) && (fi.isFocused(n) || fi.focus(n), X(n, Ed, { item: n }));
  }
  function Ol(n) {
    X(n, Dd, { item: n });
  }
  ...
  function Il(n) {
    return Re(n, 'items')
      ? ((r = co(
        ...
        (i = tm(e.items)),
        { item: r, menus: co(i.menus, yo(e.title, i.items)), expansions: co(i.expansions, yo(e.title, e.title)) })
      ...
      g =
        ...
        (i = (r = function (n) {
          return B(n, function (n) {
            return void 0 === n.items ? (!Re(n, 'format') || e.formatter.canApply(n.format) ? [n] : []) : 0 < r(n.items).length ? [n] : [];
          });
        })(n)),
        tm(i));
    return (
      ...
      b = (a = function (n) {
        return Z(n, function (n) {
          ...
          return Re(n, 'format')
            ...
            : ((o = Gu((t = n).title)), (r = co(t, { format: o, isSelected: y(o), getPreview: x(o) })), c.formatter.register(o, r), r);
          var t, o, r;
        });
  ...
  !(function () {
    ...
    'object' == typeof qf && void 0 !== Yf ? (Yf.exports = e()) : ((n = 'undefined' != typeof globalThis ? globalThis : n || self).EphoxContactWrapper = e());
  })();
  function ql(r, n) {
    return {
      uid: r.uid,
  ...
  var Kl,
    ...
    od = wa({
      ...
      factory: function (t) {
        return {
          uid: t.uid,
          dom: t.dom,
          behaviours: $c(t.dataBehaviours, [hf.config({ store: { mode: 'memory', initialValue: t.getInitialValue() } }), ed.config({ find: mn.some })]),
          events: qo([
            Yo(function (n, e) {
    ...
    rd = wa({
      ...
      factory: function (n, e) {
        return {
          uid: n.uid,
          dom: { tag: (o = n).tag, attributes: y({ type: 'text' }, o.inputAttributes), styles: o.inputStyles, classes: o.inputClasses },
          components: [],
          behaviours:
            ((t = n),
            y(
    ...
    pd =
      ...
      function (n) {
        var r,
          e = {
            field: function (n, e) {
              return r.push(n), (t = al(n)), (o = e), { uiType: Yc(), owner: 'form', name: t, config: o, validated: {} };
              var t, o;
            },
            record: w((r = [])),
          },
                  ...
                  Ql((n = r)).fold(
                    ...
                    function (n) {
                      return (
                        ...
                        (r = Be(e, 'title')),
                        (i = Be(e, 'target')),
                        { url: Zf(o), text: t !== o ? Zf(t) : '', title: Zf(r), target: Zf(i), link: mn.some(e) }
                      );
                      var e, t, o, r, i;
                    }
                  )
    ...
    wd = function (n, c) {
      ...
      return (
        ...
        0 < (u = { errors: t, values: o }).errors.length
          ? ht.error(V(u.errors))
          : ((i = e), 0 === (r = u.values).length ? ht.value(i) : ht.value(co(i, ao.apply(void 0, r))))
      );
    },
      ...
      Dr('builder', function (n) {
        return {
          ...
          domModification: y(y({}, n.domModification), {
            attributes: y(
              y(y({ role: n.toggling.isSome() ? 'menuitemcheckbox' : 'menuitem' }, n.domModification.attributes), { 'aria-haspopup': n.hasSubmenu }),
      ...
      factory: function (n, e, t, o) {
        return {
          ...
          behaviours: Lu(n.menuBehaviours, [
            Qi.config({ highlightClass: n.markers.selectedItem, itemClass: n.markers.item, onHighlight: n.onHighlight }),
          ...
          var o,
            ...
            e =
              ...
              De(c.data.menus, function (n, e) {
                function t() {
                  return Pd.sketch(
                    y(y({}, n), { value: e, markers: c.markers, fakeFocus: c.fakeFocus, onHighlight: c.onHighlight, focusManager: (c.fakeFocus ? Vi : Ii)() })
                  );
                }
              ...
              mn.from(o[0]).bind(function (t) {
                return m.lookupMenu(t).bind(function (n) {
                  ...
                  return (
                    ...
                    u === d.HighlightSubmenu ? (Qi.highlightFirst(e), l(r, m, o)) : (Qi.dehighlightAll(e), mn.some(i))
                  );
                });
              })
            );
    ...
    Jd = Ao({
      fields: [
        ...
        kr('onTransition'),
        kr('onFinish'),
        $t('routes', Nt(ht.value, Nt(ht.value, It([qt('transition', [Lt('property'), Lt('transitionClass')])])))),
      ],
      name: 'transitioning',
      active: Kd,
      apis: Yd,
      ...
      return {
        ...
        components: [
          Qs.sketch({
            ...
            components: o ? [{ dom: { tag: 'span', classes: [ci('styles-collapse-icon')] } }, wl(n)] : [wl(n)],
            action: function (n) {
              var e;
        ...
        menuBehaviours: or([
          Jd.config({
            initialState: 'after',
            routes: Jd.createTristate('before', 'current', 'after', { transition: { property: 'transform', transitionClass: 'transitioning' } }),
          }),
        ]),
      };
    },
    ...
    cm = Jt([{ ltr: ['start', 'soffset', 'finish', 'foffset'] }, { rtl: ['start', 'soffset', 'finish', 'foffset'] }]);
  function am(n, e) {
    var t = le(n);
    ...
    var t,
      ...
      e = Ns(
        td.sketch({
          ...
          containerBehaviours: or([ii.config({ toggleClass: ci('mask-tap-icon-selected'), toggleOnExecute: !1 })]),
        })
      ),
      r =
        ((t = n),
    ...
    var o = Td(
        Eg.sketch({
          ...
          toolbarBehaviours: or([
            ii.config({ toggleClass: ci('context-toolbar'), toggleOnExecute: !1, aria: { mode: 'none' } }),
      ...
      n = Td(
        td.sketch({
          ...
          components: [Cd(o)],
          containerBehaviours: or([ii.config({ toggleClass: ci('android-selection-context-toolbar'), toggleOnExecute: !1 })]),
        })
      ),
      r = No([]);
    return {
  ...
  function zm() {
    return Td(td.sketch({ dom: Oa('<div class="${prefix}-editor-socket"></div>'), components: [], containerBehaviours: or([jd.config({})]) }));
  }
  function jm(n, e, t, o) {
    ...
    return {
      registerId: function (r, i, n) {
        Ee(n, function (n, e) {
          var t,
            o = void 0 !== u[e] ? u[e] : {};
          (o[i] = { cHandler: J.apply(void 0, [(t = n).handler].concat(r)), purpose: t.purpose }), (u[e] = o);
        });
      },
  ...
  var cg,
    ...
    gg = Jt([{ domRange: ['rng'] }, { relative: ['startSitu', 'finishSitu'] }, { exact: ['start', 'soffset', 'finish', 'foffset'] }]),
    pg = {
    ...
    Eg = Sa({
      ...
      factory: function (o, n, e, t) {
        var r = o.shell ? { behaviours: [jd.config({})], components: [] } : { behaviours: [], components: n };
        return {
          uid: o.uid,
          dom: o.dom,
    ...
    _g = Sa({
      ...
      factory: function (n, e, t, o) {
        return {
          ...
          dom: n.dom,
          components: e,
          behaviours: Lu(n.tgroupBehaviours, [jc.config({ mode: 'flow', selector: n.markers.itemSelector })]),
    ...
    Ig = Object.freeze({
      ...
      exhibit: function (n, e, t) {
        return Io(e.expanded ? { classes: [e.openClass], styles: {} } : { classes: [e.closedClass], styles: yo(e.dimension.property, '0px') });
      },
      events: function (t, o) {
        return qo([
          Mo(Wn())(function (n, e) {
            e.event.raw.propertyName === t.dimension.property &&
              (Um(n, t), o.isExpanded() && Xr(n.element, t.dimension.property), (o.isExpanded() ? t.onGrown : t.onShrunk)(n));
          }),
        ]);
      },
    }),
    ...
    Pg = ci('edit-mode');
  function zg(n) {
    var e = Td(td.sketch({ dom: { classes: [ci('outer-container')].concat(n.classes) }, containerBehaviours: or([cr.config({ alpha: Hg, omega: Pg })]) }));
    return Ng(e);
  }
  function jg(n, e) {
    var t = fe.fromTag('input');
    Gr(t, { opacity: '0', position: 'absolute', top: '-1000px', left: '-1000px' }), Qe(n, t), Ho(t), e(t), Ze(t);
  }
  function Lg(n) {
    var e,
      t,
            ...
            bp(N, H.pageYOffset).get(function () {
              ...
              mn
                ...
                .bind(function (n) {
                  ...
                  return e > H.innerHeight + 5 || e < -5 ? mn.some({ top: e, bottom: e + n.height }) : mn.none();
                })
                .each(function (n) {
      ...
      q = (function (e, t) {
        ...
        function r(n) {
          ...
          return (
            ...
            Gr(e, { left: n.left + 'px', top: n.top + 'px', width: n.width + 'px', height: n.height + 'px' }),
            e
          );
        }
  ...
  sr.add('mobile', function (E) {
    return {
      getNotificationManagerImpl: function () {
        return {
          open: w({ progressBar: { value: Y }, close: Y, text: Y, getEl: w(null), moveTo: Y, moveRel: Y, settings: {} }),
          close: Y,
          reposition: Y,
          getArgs: w({}),
        };
      ...
      renderUI: function () {
        ...
        var T = t.ownerDocument.defaultView,
          C = Ll(T, {
            onChange: function () {
              var n, e, t;
              w.system.broadcastOn([mr], { width: ((n = T), (e = Fn().os.isiOS()), (t = jl(n).isPortrait()), e && !t ? n.screen.height : n.screen.width) });
            },
            onReady: Y,
          });
        return (
