!(function (t, e) {
    ...
    d = {
      ...
      parse: {
        ...
        regexp: function (t) {
          var e = '';
          return (
            (t = /^\/.*\/(?:[gimy]*)$/.test(t) ? ((e = t.replace(/.*\/([gimy]*)$/, '$1')), t.replace(new RegExp('^/(.*?)/' + e + '$'), '$1')) : '^' + t + '$'),
            new RegExp(t, e)
          );
        },
      },
  ...
  (v.Form = {
    ...
    (v.Field = {
      ...
      _manageClassHandler: function () {
        ...
        if (
          ('string' == typeof this.options.classHandler && 'function' == typeof window[this.options.classHandler] && (t = window[this.options.classHandler]),
          'function' == typeof t)
        ) {
  ...
  function b(t, e, i, r, n) {
    var s = window.Parsley._validatorRegistry.validators[e],
      a = new c(s);
    l(this, { validator: a, name: e, requirements: i, priority: (r = r || t.options[e + 'Priority'] || a.priority), isDomConstraint: (n = !0 === n) }),
  ...
  w.prototype = {
    ...
    getValue: function () {
      var t;
      return null ==
        (t = 'function' == typeof this.options.value ? this.options.value(this) : void 0 !== this.options.value ? this.options.value : this.$element.val())
        ? ''
  ...
  A.prototype = {
    ...
    handleMultiple: function () {
      ...
      if (!this.options.multiple)
        return (
          d.warn('To be bound by Parsley, a radio, a checkbox and a multiple select input must have either a name or a multiple option.', this.$element), this
        );
  ...
  (window.ParsleyValidator = {}),
      ...
      function (t, e) {
        (window.Parsley[e] = function () {
          ...
          (window.ParsleyValidator[e] = function () {
            var t;
            return (
              d.warnOnce("Accessing the method '".concat(e, "' through Validator is deprecated. Simply call 'window.Parsley.").concat(e, "(...)'")),
    ...
    h.each('addError updateError'.split(' '), function (t, a) {
      window.ParsleyUI[a] = function (t, e, i, r, n) {
        ...
        return (
          d.warnOnce(
            "Accessing UI is deprecated. Call '".concat(a, "' on the instance directly. Please comment in issue 1073 as to your need to call this method.")
          ),
  ...
  return (
    (h.listen = function (t, e) {
      var i;
      if ((V(), 'object' === n(arguments[1]) && 'function' == typeof arguments[2] && ((i = arguments[1]), (e = arguments[2])), 'function' != typeof e))
    ...
    (r.prototype.addAsyncValidator = function () {
      return (
        d.warnOnce('Accessing the method `addAsyncValidator` through an instance is deprecated. Simply call `Parsley.addAsyncValidator(...)`'),
