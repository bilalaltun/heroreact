        ...
        if (validMutation) {
          ...
          if (receivingCalendar === initialCalendar_1) {
            ...
            receivingCalendar.publiclyTrigger('eventReceive', [
              {
                draggedEl: ev.subjectEl,
                event: new EventApi(receivingCalendar, mutatedRelevantEvents.defs[eventDef.defId], mutatedRelevantEvents.instances[eventInstance.instanceId]), // the data AFTER the mutation
                view: finalHit.component, // should this be finalHit.component.view? See #4644
              },
            ]);
          }
