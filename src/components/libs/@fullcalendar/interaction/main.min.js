      ...
      return (
        ...
        (e.prototype.tryStart = function (e) {
          ...
          return (
            ...
            ((this.subjectEl = n), (this.downEl = r), (this.isDragging = !0), (this.wasTouchScroll = !1), !0)
          );
        }),
        ...
        (e.prototype.createEventFromTouch = function (e, t) {
          ...
          return (
            ...
            t ? ((this.origPageX = n), (this.origPageY = r)) : ((o = n - this.origPageX), (a = r - this.origPageY)),
            { origEvent: e, isTouch: !0, subjectEl: this.subjectEl, pageX: n, pageY: r, deltaX: o, deltaY: a }
          );
        }),
        e
      );
  ...
  var d = (function () {
      ...
      return (
        ...
        (e.prototype.updateElPosition = function () {
          this.sourceEl &&
            this.isVisible &&
            t.applyStyle(this.getMirrorEl(), { left: this.sourceElRect.left + this.deltaX, top: this.sourceElRect.top + this.deltaY });
        }),
        ...
        (e.prototype.computeBestEdge = function (e, t) {
          for (var n = this.edgeThreshold, r = null, i = 0, o = this.scrollCaches; i < o.length; i++) {
            ...
            s >= 0 &&
              ...
              d >= 0 &&
              g >= 0 &&
              (d <= n && this.everMovedUp && a.canScrollUp() && (!r || r.distance > d) && (r = { scrollCache: a, name: 'top', distance: d }),
      ...
      (this.useSubjectCenter = !1),
        ...
        (this.handlePointerDown = function (e) {
          ...
          (r.initialHit = null),
            ...
            r.initialHit || !r.requireInitial ? (t.setIgnoreMove(!1), r.emitter.trigger('pointerdown', e)) : t.setIgnoreMove(!0);
        }),
        ...
        for (var a in r) {
          ...
          if (s.isWithinClipping(e, n)) {
            ...
            if (g >= 0 && g < p && u >= 0 && u < v) {
              ...
              !f ||
                (l.props.dateProfile && !t.rangeContainsRange(l.props.dateProfile.activeRange, f.dateSpan.range)) ||
                (o && !(f.layer > o.layer)) ||
                ((f.rect.left += c), (f.rect.right += c), (f.rect.top += d), (f.rect.bottom += d), (o = f));
            }
          }
        }
        return o;
          ...
          (r.handleHitUpdate = function (e, n) {
            ...
            e &&
              (((a = (function (e, n, r) {
                ...
                ((l = !0), (a = null))),
              a ? o.dispatch({ type: 'SELECT_DATES', selection: a }) : n || o.dispatch({ type: 'UNSELECT_DATES' }),
    ...
    function n(r) {
      ...
      (o.subjectSeg = null),
        ...
        (o.handleDragStart = function (e) {
          ...
          e.isTouch
            ? a !== o.component.props.eventSelection && r.dispatch({ type: 'SELECT_EVENT', eventInstanceId: a })
            : r.dispatch({ type: 'UNSELECT_EVENT' }),
            o.isDragging &&
              (r.unselect(e),
              r.publiclyTrigger('eventDragStart', [{ el: o.subjectSeg.el, event: new t.EventApi(r, i.def, i.instance), jsEvent: e.origEvent, view: n.view }]));
        }),
              ...
              a === l || (h.editable && h.droppable)
                ? (s = (function (e, n, r) {
                    var i = e.dateSpan,
                      ...
                      s = {};
                    i.allDay !== o.allDay &&
                      ((s.allDay = o.allDay), (s.hasEnd = n.component.context.options.allDayMaintainDuration), o.allDay && (a = t.startOfDay(a)));
                  ...
                  (g.mutatedEvents = c),
                  u.isInteractionValid(g) || ((d = !0), (s = null), (c = null), (g.mutatedEvents = t.createEmptyEventStore())))
                : (l = null);
            }
            o.displayDrag(l, g),
              ...
              if (s === r) {
                ...
                s.publiclyTrigger('drop', [D]),
                  s.publiclyTrigger('eventReceive', [
                    { draggedEl: e.subjectEl, event: new t.EventApi(s, p.defs[d.defId], p.instances[g.instanceId]), view: v.component },
                  ]);
              }
      ...
      (n.prototype.displayDrag = function (e, n) {
        ...
        i &&
          ...
          (i === r
            ? i.dispatch({
                type: 'SET_EVENT_DRAG',
                state: { affectedEvents: n.affectedEvents, mutatedEvents: t.createEmptyEventStore(), isEvent: !0, origSeg: n.origSeg },
              })
    ...
    function n(n) {
      ...
      (r.draggingSeg = null),
        ...
        (r.handlePointerDown = function (e) {
          ...
          (r.dragging.minDistance = t.context.options.eventDragMinDistance),
            r.dragging.setIgnoreMove(
              !r.component.isValidSegDownEl(e.origEvent.target) || (e.isTouch && r.component.props.eventSelection !== i.instance.instanceId)
            );
        }),
        (r.handleDragStart = function (e) {
          ...
          (r.relevantEvents = t.getRelevantEvents(i.state.eventStore, r.eventRange.instance.instanceId)),
            ...
            i.unselect(),
            i.publiclyTrigger('eventResizeStart', [{ el: r.draggingSeg.el, event: new t.EventApi(i, a.def, a.instance), jsEvent: e.origEvent, view: o }]);
        }),
        (r.handleHitUpdate = function (e, n, o) {
          ...
          e &&
            (d = (function (e, n, r, o, a) {
              ...
              return null;
            })(s, e, o.subjectEl.classList.contains('fc-start-resizer'), c.range, a.pluginSystem.hooks.eventResizeJoinTransforms)),
            d &&
              ((g = t.applyMutationToEventStore(l, a.eventUiBases, d, a)),
              (h.mutatedEvents = g),
              r.component.isInteractionValid(h) || ((u = !0), (d = null), (g = null), (h.mutatedEvents = null))),
            g ? a.dispatch({ type: 'SET_EVENT_RESIZE', state: h }) : a.dispatch({ type: 'UNSET_EVENT_RESIZE' }),
        ...
        (r.handleDragEnd = function (e) {
          ...
          i.publiclyTrigger('eventResizeStop', [{ el: r.draggingSeg.el, event: s, jsEvent: e.origEvent, view: o }]),
            r.validMutation
          ...
          (this.handleHitUpdate = function (e, n, o) {
            ...
            e &&
              ...
              r.canDropElOnCalendar(o.subjectEl, l) &&
                ...
                (c = !t.isInteractionValid(d, l)) && ((d.mutatedEvents = t.createEmptyEventStore()), (s = null)))),
              r.displayDrag(l, d),
