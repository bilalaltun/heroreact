      ...
      return (
        ...
        (r.prototype.renderSegs = function (r, i, n) {
          e.prototype.renderSegs.call(this, r, i, n),
            (this.fullTimeFormat = t.createFormatter({ hour: 'numeric', minute: '2-digit', separator: this.context.options.defaultRangeSeparator }));
        }),
        ...
        (r.prototype.renderSegHtml = function (e, r) {
          ...
          return (
            ...
            (i
              ? '<div class="fc-time" data-start="' + t.htmlEscape(o) + '" data-full="' + t.htmlEscape(n) + '"><span>' + t.htmlEscape(i) + '</span></div>'
              : '') +
          ...
          if (
            ((function (e) {
              ...
              for (t = 0; t < e.length; t++)
                for (r = e[t], i = 0; i < r.length; i++) for ((n = r[i]).forwardSegs = [], o = t + 1; o < e.length; o++) l(n, e[o], n.forwardSegs);
            })(
              (t = (function (e) {
                var t,
                  r,
    ...
    p = (function (e) {
      ...
      return (
        ...
        (i.prototype._renderSkeleton = function (e) {
          var t = this.el;
          (t.innerHTML =
            '<div class="fc-bg"></div><div class="fc-slats"></div><hr class="fc-divider ' + e.getClass('widgetHeader') + '" style="display:none" />'),
        ...
        (i.prototype._renderColumns = function (e, i) {
          ...
          (this.rootBgContainerEl.innerHTML =
            ...
            '">' +
            c.renderHtml({ cells: e, dateProfile: i, renderIntroHtml: this.renderProps.renderBgIntroHtml }) +
            '</table>'),
        ...
        (i.prototype._renderEventDrag = function (e) {
          e &&
            ...
            e.isEvent
              ? this.mirrorRenderer.renderSegs(this.context, e.segs, { isDragging: !0, sourceSeg: e.sourceSeg })
        ...
        (i.prototype._unrenderEventDrag = function (e) {
          e &&
            ...
            e.isEvent
              ? this.mirrorRenderer.unrender(this.context, e.segs, { isDragging: !0, sourceSeg: e.sourceSeg })
    ...
    m = (function (e) {
            ...
            return s.weekNumbers
              ? ((e = o.format(a.start, g)),
                '<th class="fc-axis fc-week-number ' +
                  ...
                  r.axisStyleAttr() +
                  '>' +
                  t.buildGotoAnchorHtml(s, o, { date: a.start, type: 'week', forceOff: l > 1 }, t.htmlEscape(e)) +
                  '</th>')
      ...
      return (
        ...
        (i.prototype._renderSkeleton = function (e) {
          ...
          if (
            (i.appendChild(n),
            (this.timeGrid = new p(n, { renderBgIntroHtml: this.renderTimeGridBgIntroHtml, renderIntroHtml: this.renderTimeGridIntroHtml })),
        ...
        (i.prototype.updateBaseSize = function (e, r, i) {
          ...
          if (((this.axisWidth = t.matchCellWidths(t.findElements(this.el, '.fc-axis'))), this.timeGrid.colEls)) {
            ...
            (this.timeGrid.bottomRuleEl.style.display = 'none'),
              ...
              this.dayGrid &&
                (this.dayGrid.removeSegPopover(), (n = this.context.options.eventLimit) && 'number' != typeof n && (n = 5), n && this.dayGrid.limitRows(n)),
              i ||
    ...
    C = (function (e) {
      ...
      return (
        ...
        (i.prototype.render = function (t, r) {
          ...
          this.header &&
            this.header.receiveProps({ dateProfile: n, dates: l.headerDates, datesRepDistinctDays: !0, renderIntroHtml: this.renderHeadIntroHtml }, r),
