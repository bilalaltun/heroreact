...
var DayGrid = /** @class */ (function (_super) {
  ...
  DayGrid.prototype.renderNumberCellHtml = function (date) {
    ...
    html += '<td class="' + classes.join(' ') + '"' + (isDateValid ? ' data-date="' + dateEnv.formatIso(date, { omitTime: true }) + '"' : '') + '>';
...
var SimpleDayGrid = /** @class */ (function (_super) {
  ...
  SimpleDayGrid.prototype.render = function (props, context) {
    ...
    dayGrid.receiveProps(
      __assign({}, this.slicer.sliceProps(props, dateProfile, props.nextDayThreshold, context.calendar, dayGrid, dayTable), {
