...
!(function (e, t) {
      ...
      return (
        ...
        (r.prototype.buildRenderRange = function (r, n, i) {
          var o,
            ...
            d = l.end;
          if (
            (/^(year|month)$/.test(n) && ((a = s.startOfWeek(a)), (o = s.startOfWeek(d)).valueOf() !== d.valueOf() && (d = t.addWeeks(o, 1))),
      ...
      return (
        ...
        (r.prototype.renderSegHtml = function (e, r) {
          ...
          return (
            ...
            e.isStart && (n = this.getTimeText(s)) && (m = '<span class="fc-time">' + t.htmlEscape(n) + '</span>'),
    ...
    a = (function (e) {
      ...
      return (
        ...
        (r.prototype.renderSegRow = function (e, r) {
          ...
          function b(e) {
            for (; o < e; )
              (d = (v[n - 1] || [])[o]) ? (d.rowSpan = (d.rowSpan || 1) + 1) : ((d = document.createElement('td')), s.appendChild(d)),
                (y[n][o] = d),
                (v[n][o] = d),
                o++;
          }
          for (n = 0; n < f; n++) {
            if (((i = u[n]), (o = 0), (s = document.createElement('tr')), g.push([]), y.push([]), v.push([]), i))
              for (l = 0; l < i.length; l++) {
                ...
                for (b(S), d = t.createElement('td', { className: 'fc-event-container' }, a.el), S !== w ? (d.colSpan = w - S + 1) : (v[n][o] = d); o <= w; )
                  (y[n][o] = d), (g[n][o] = a), o++;
                s.appendChild(d);
              }
            b(p);
      ...
      return (
        ...
        (r.prototype.renderFillRow = function (e, r) {
          ...
          (n = 'businessHours' === e ? 'bgevent' : e.toLowerCase()),
            (o = (i = t.htmlToElement('<div class="fc-' + n + '-skeleton"><table><tr></tr></table></div>')).getElementsByTagName('tr')[0]),
            d > 0 && t.appendToElement(o, new Array(d + 1).join('<td style="pointer-events:none"></td>')),
            (r.el.colSpan = c - d),
            o.appendChild(r.el),
            c < a && t.appendToElement(o, new Array(a - c + 1).join('<td style="pointer-events:none"></td>'));
    ...
    u = (function (e) {
      function r(r) {
        ...
        return (
          ...
          (n.renderEventSelection = t.memoizeRendering(i.selectByInstanceId.bind(i), i.unselectByInstanceId.bind(i), [n.renderFgEvents])),
          (n.renderEventDrag = t.memoizeRendering(i.hideByHash.bind(i), i.showByHash.bind(i), [o])),
          (n.renderEventResize = t.memoizeRendering(i.hideByHash.bind(i), i.showByHash.bind(i), [o])),
          n
        );
      }
      return (
    ...
    m = (function () {
      ...
      return (
        (e.prototype.renderHtml = function (e) {
          ...
          return (
            e.cells.length || t.push('<td class="fc-day ' + this.context.theme.getClass('widgetContent') + '"></td>'),
  ...
  function g(e, r, n, i) {
    ...
    return (
      ...
      '<td class="' + a.join(' ') + '"' + (l ? ' data-date="' + o.formatIso(e, { omitTime: !0 }) + '"' : '') + (i ? ' ' + i : '') + '></td>'
    );
  }
  var y = t.createFormatter({ day: 'numeric' }),
    ...
    b = (function (e) {
      function r(r, n) {
        ...
        return (
          (i.renderBusinessHours = t.memoizeRendering(s.renderSegs.bind(s, 'businessHours'), s.unrender.bind(s, 'businessHours'), [l])),
          (i.renderDateSelection = t.memoizeRendering(s.renderSegs.bind(s, 'highlight'), s.unrender.bind(s, 'highlight'), [l])),
          (i.renderBgEvents = t.memoizeRendering(s.renderSegs.bind(s, 'bgEvent'), s.unrender.bind(s, 'bgEvent'), [l])),
          ...
          (i.renderEventResize = t.memoizeRendering(i._renderEventResize, i._unrenderEventResize, [l])),
          i
        );
      }
      return (
        ...
        (r.prototype.renderNumberCellHtml = function (e) {
          ...
          return d || this.renderProps.cellWeekNumbersVisible
            ? ((r = t.getDayClasses(e, this.props.dateProfile, this.context)).unshift('fc-day-top'),
              ...
              (l += '<td class="' + r.join(' ') + '"' + (a ? ' data-date="' + o.formatIso(e, { omitTime: !0 }) + '"' : '') + '>'),
              this.renderProps.cellWeekNumbersVisible &&
                e.getUTCDay() === n &&
                (l += t.buildGotoAnchorHtml(s, o, { date: e, type: 'week' }, { class: 'fc-week-number' }, o.format(e, v))),
              d && (l += t.buildGotoAnchorHtml(s, o, e, { class: 'fc-day-number' }, o.format(e, y))),
              (l += '</td>'))
            : '<td></td>';
        }),
        (r.prototype.updateSize = function (e) {
          ...
          (e || this.isCellSizesDirty || t.isEventsUpdated) && (this.buildPositionCaches(), (this.isCellSizesDirty = !1)),
            r.computeSizes(e),
            n.computeSizes(e),
            i.computeSizes(e),
            r.assignSizes(e),
        ...
        (r.prototype._renderEventResize = function (e) {
          e &&
            ...
            this.mirrorRenderer.renderSegs(this.context, e.segs, { isResizing: !0, sourceSeg: e.sourceSeg }));
        }),
        (r.prototype._unrenderEventResize = function (e) {
          e &&
            (this.eventRenderer.showByHash(e.affectedInstances),
            this.fillRenderer.unrender('highlight', this.context),
            this.mirrorRenderer.unrender(this.context, e.segs, { isResizing: !0, sourceSeg: e.sourceSeg }));
        }),
        ...
        (r.prototype.limitRows = function (e) {
          ...
          for (t = 0; t < n.length; t++)
            this.unlimitRow(t), !1 !== (r = !!e && ('number' == typeof e ? e : this.computeRowLevelLimit(t))) && this.limitRow(t, r);
        }),
            ...
            R = function (n) {
              for (; E < n; )
                (a = v.getCellSegs(e, E, r)).length &&
                  ((h = i[r - 1][E]), (y = v.renderMoreLink(e, E, a)), (g = t.createElement('div', null, y)), h.appendChild(g), C.push(g)),
                  E++;
            };
            ...
            h.addEventListener('click', function (t) {
              ...
              'function' == typeof o &&
                (o = s.publiclyTrigger('eventLimitClick', [
                  { date: a.toDate(p), allDay: !0, dayEl: f, moreEl: u, segs: g, hiddenSegs: y, jsEvent: t, view: l },
                ])),
        ...
        (r.prototype.resliceDaySegs = function (e, r) {
          for (var n = r, o = { start: n, end: t.addDays(n, 1) }, s = [], l = 0, a = e; l < a.length; l++) {
            ...
            p &&
              s.push(
                i({}, d, {
                  eventRange: { def: c.def, ui: i({}, c.ui, { durationEditable: !1 }), instance: c.instance, range: p },
          ...
          (r.renderDayGridNumberIntroHtml = function (e, n) {
            ...
            return r.colWeekNumbersVisible
              ? '<td class="fc-week-number" ' +
                  r.weekNumberStyleAttr() +
                  '>' +
                  t.buildGotoAnchorHtml(o, s, { date: l, type: 'week', forceOff: 1 === n.colCnt }, s.format(l, S)) +
                  '</td>'
              : '';
          }),
            ...
            ? (this.colWeekNumbersVisible && (this.weekNumberWidth = t.matchCellWidths(t.findElements(this.el, '.fc-week-number'))),
              ...
              n ||
                ...
                ((o = this.scroller.getScrollbarWidths()).left || o.right) &&
                  (a && t.compensateScroll(a, o), (i = this.computeScrollerHeight(r)), this.scroller.setHeight(i)),
  ...
  var C = (function (e) {
      ...
      return (
        ...
        (t.prototype.render = function (e, t) {
          ...
          r.receiveContext(t),
            r.receiveProps(
              i({}, this.slicer.sliceProps(e, n, e.nextDayThreshold, t.calendar, r, o), { dateProfile: n, cells: o.cells, isRigid: e.isRigid }),
              t
            );
        }),
        ...
        (r.prototype.render = function (t, r) {
          ...
          this.header &&
            this.header.receiveProps(
              { dateProfile: n, dates: i.headerDates, datesRepDistinctDays: 1 === i.rowCnt, renderIntroHtml: this.renderHeadIntroHtml },
              r
            ),
