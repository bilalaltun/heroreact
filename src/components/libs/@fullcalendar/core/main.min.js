...
!(function (e, t) {
    ...
    r.hasPublicHandlers('eventRender') &&
      (t = t.filter(function (e) {
        var t = r.publiclyTrigger('eventRender', [
          { event: new ct(r, e.eventRange.def, e.eventRange.instance), isMirror: n, isStart: e.isStart, isEnd: e.isEnd, el: e.el, view: i },
        ]);
    ...
    if (r.hasPublicHandlers('eventPositioned'))
      for (var o = 0, a = t; o < a.length; o++) {
        ...
        r.publiclyTriggerAfterSizing('eventPositioned', [
          { event: new ct(r, s.eventRange.def, s.eventRange.instance), isMirror: n, isStart: s.isStart, isEnd: s.isEnd, el: s.el, view: i },
        ]);
      }
  ...
  function Zt(e, t, n, r) {
    ...
    if (a)
      return (
        ((s = jt(o, t, a.allDay, Boolean(a.duration), n)).recurringDef = { typeId: a.typeId, typeData: a.typeData, duration: a.duration }),
        { def: s, instance: null }
      );
    var s,
      u = {},
    ...
    rn = (function (e) {
      ...
      return (
        ...
        (t.prototype.hasHandlers = function (e) {
          return (
            (this._handlers && this._handlers[e] && this._handlers[e].length) || (this._oneHandlers && this._oneHandlers[e] && this._oneHandlers[e].length)
          );
        }),
        t
      );
      ...
      return (
        ...
        (e.prototype.receiveProps = function (e, t) {
          ...
          var n = (function (e, t, n) {
            ...
            i = n.comboProps;
          (this.props = i),
            r && (this.everRendered && this.beforeUpdate(), this.render(i, t), this.everRendered && this.afterUpdate()),
            (this.everRendered = !0);
        }),
          ...
          if (s) {
            ...
            return (
              ...
              !l &&
                ...
                ((r = a.endTime),
                (i = a.startTime),
                (l = { years: r.years - i.years, months: r.months - i.months, days: r.days - i.days, milliseconds: r.milliseconds - i.milliseconds })),
  ...
  var Fn = (function () {
      ...
      return (
        ...
        (e.prototype.diffWholeYears = function (e, t) {
          ...
          return q(e) === q(t) && n.getMarkerDay(e) === n.getMarkerDay(t) && n.getMarkerMonth(e) === n.getMarkerMonth(t)
          ...
          return (
            ...
            (function (e, t, n) {
              ...
              return (
                ...
                r.length > 10 && (null == t ? (r = r.replace('Z', '')) : 0 !== t && (r = r.replace('Z', at(t, !0)))),
                r
              );
            })(e, n, t.omitTime)
          );
  ...
  function Jn(e, t, n) {
    return Kn(
      ...
      we(e, function (e) {
        return (function (e, t, n) {
          return jn(e, n)
            ? !n.opt('lazyFetching') || !e.fetchRange || e.isFetching || t.start < e.fetchRange.start || t.end > e.fetchRange.end
            : !e.latestFetchId;
        })(e, t, n);
      }),
      t,
      ...
      r.fetch(
        ...
        function (r) {
          ...
          e.success && (a = e.success(s, r.xhr)),
            u && (o = u(s, r.xhr)),
            (s = a || o || s),
            n.dispatch({ type: 'RECEIVE_EVENTS', sourceId: e.sourceId, fetchId: i, fetchRange: t, rawEvents: s });
        },
        function (r) {
          ...
          console.warn(r.message, r),
            ...
            o && o(r),
            n.dispatch({ type: 'RECEIVE_EVENT_ERROR', sourceId: e.sourceId, fetchId: i, fetchRange: t, error: r });
        }
      ),
      ...
      (e.prototype.adjustActiveRange = function (e, t, n) {
        ...
        return (
          this.viewSpec.class.prototype.usesMinMaxTime &&
            (ee(t) < 0 && ((i = B(i)), (i = r.add(i, t))), ee(n) > 1 && ((o = x((o = B(o)), -1)), (o = r.add(o, n)))),
          { start: i, end: o }
        );
      }),
          ...
          switch (t.type) {
            ...
            case 'SET_VIEW_TYPE':
              ...
              if (!a)
                throw new Error(
                  r
                    ? 'The FullCalendar view "' + r + '" does not exist. Make sure your plugins are loaded correctly.'
    ...
    yr = (function (e) {
      ...
      return (
        ...
        (t.prototype._renderToolbars = function (e, t, n, r) {
          ...
          d
            ? (o || ((o = this.header = new gr('fc-header-toolbar')), u(this.el, o.el)), o.receiveProps(Se({ layout: d }, m), i))
            : o && (o.destroy(), (o = this.header = null)),
            f
              ? (a || ((a = this.footer = new gr('fc-footer-toolbar')), s(this.el, a.el)), a.receiveProps(Se({ layout: f }, m), i))
      ...
      function t(t) {
        ...
        n.handleSegClick = function (e, t) {
          ...
          if (s && r.isValidSegDownEl(e.target)) {
            ...
            o.publiclyTrigger('eventClick', [{ el: t, event: new ct(r.context.calendar, s.eventRange.def, s.eventRange.instance), jsEvent: e, view: a }]),
      ...
      return (
        ...
        (t.prototype.triggerEvent = function (e, t, n) {
          ...
          (t && !r.isValidSegDownEl(t.target)) ||
            o.publiclyTrigger(e, [{ el: n, event: new ct(o, s.eventRange.def, s.eventRange.instance), jsEvent: t, view: a }]);
        }),
        t
      );
    })(br),
    ...
    return (
      ...
      (e.prototype.render = function () {
        this.component
          ...
          : ((this.component = new yr(this.el)), (this.renderableEventStore = { defs: {}, instances: {} }), this.bindHandlers(), this.executeRender());
      }),
      (e.prototype.destroy = function () {
        if (this.component) {
      ...
      (e.prototype.bindHandlers = function () {
        ...
        (this.removeNavLinkListener = _(this.el, 'click', 'a[data-goto]', function (t, n) {
          ...
          this.opt('handleWindowResize') &&
            window.addEventListener('resize', (this.windowResizeProxy = pe(this.windowResize.bind(this), this.opt('windowResizeDelay'))));
      }),
        ...
        if ((this.actionQueue.push(e), !this.isReducing)) {
          ...
          t.eventStore !== n.eventStore && t.eventStore && (this.isEventsUpdated = !0),
            t.dateProfile !== n.dateProfile &&
              (t.dateProfile && r && this.publiclyTrigger('datesDestroy', [{ view: r, el: r.el }]), (this.isDatesUpdated = !0)),
      ...
      (e.prototype.mutateOptions = function (e, t, n, r) {
        ...
        this.optionsManager.mutate(a, t, n),
          ...
          this.batchRendering(function () {
            if (
              (d
                ? (l && i.dispatch({ type: 'CHANGE_TIMEZONE', oldDateEnv: u }), i.dispatch({ type: 'SET_VIEW_TYPE', viewType: i.state.viewType }))
                : c && i.updateSize(),
              r)
            )
      ...
      (e.prototype.changeView = function (e, t) {
        ...
        t &&
          (t.start && t.end
            ? (this.optionsManager.mutate({ visibleRange: t }, []), this.handleOptions(this.optionsManager.computed))
      ...
      (e.prototype.zoomTo = function (e, t) {
        ...
        (t = t || 'day'),
          ...
          this.unselect(),
          n ? this.dispatch({ type: 'SET_VIEW_TYPE', viewType: n.type, dateMarker: e }) : this.dispatch({ type: 'SET_DATE', dateMarker: e });
      }),
      (e.prototype.getUnitViewSpec = function (e) {
        var t,
          ...
          r = this.component,
          i = [];
        for (var o in (r.header && i.push.apply(i, r.header.viewsWithButtons), r.footer && i.push.apply(i, r.footer.viewsWithButtons), this.viewSpecs))
          i.push(o);
      ...
      (e.prototype.buildDatePointApi = function (e) {
        ...
        return (
          Se(r, ((t = e), { date: (n = this.dateEnv).toDate(t.range.start), dateStr: n.formatIso(t.range.start, { omitTime: t.allDay }), allDay: t.allDay })), r
        );
      }),
    ...
    return (
      ...
      (t.prototype.updateNowIndicator = function () {
        this.props.dateProfile &&
          ...
          this.renderNowIndicator(N(this.initialNowDate, new Date().valueOf() - this.initialNowQueriedMs)),
    ...
    return (
      ...
      (e.prototype.getSegClasses = function (e, t, n, r) {
        ...
        return (
          ...
          r && (i.push('fc-mirror'), r.isDragging && i.push('fc-dragging'), r.isResizing && i.push('fc-resizing')),
          i
        );
      }),
  ...
  var Zr = (function (e) {
      ...
      return (
        ...
        (t.prototype._renderSkeleton = function (e) {
          ...
          (n.innerHTML = ''),
            n.appendChild(
              (this.el = i('<div class="fc-row ' + t.getClass('headerRow') + '"><table class="' + t.getClass('tableGrid') + '"><thead></thead></table></div>'))
            ),
