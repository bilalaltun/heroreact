...
!(function (n) {
  ...
  function a(e, t) {
    ...
    (this.s = { childNodeStore: {}, columns: [], current: [], dt: new r.Api(e) }),
      ...
      (f.extend(a.prototype, {
            ...
            var i = this.s.dt,
              ...
              r = f.map(e, function (e, t) {
                return !1 === i.column(t).visible()
                  ? 'not-visible'
                  : (!e.auto || null !== e.minWidth) && (!0 === e.auto ? '-' : -1 !== f.inArray(n, e.includeIn));
              }),
              s = 0,
              o = 0,
              d = r.length;
        ...
        _classLogic: function () {
          function d(e, t, n, i) {
            var r, s, o;
            if (n) {
              if ('max-' === n) for (r = a._find(t).width, s = 0, o = l.length; s < o; s++) l[s].width <= r && u(e, l[s].name);
              else if ('min-' === n) for (r = a._find(t).width, s = 0, o = l.length; s < o; s++) l[s].width >= r && u(e, l[s].name);
              else if ('not-' === n) for (s = 0, o = l.length; s < o; s++) -1 === l[s].name.indexOf(i) && u(e, l[s].name);
        ...
        _detailsDisplay: function (t, n) {
          ...
          o &&
            !1 !== o.type &&
            ((i = 'string' == typeof o.renderer ? a.renderer[o.renderer]() : o.renderer),
            'boolean' ==
              typeof (o = o.display(
                t,
                n,
        ...
        _detailsInit: function () {
          ...
          (r === h && null === r) ||
            f(i.table().body()).on('click.dtr mousedown.dtr mouseup.dtr', e, function (e) {
              if (f(i.table().node()).hasClass('collapsed') && -1 !== f.inArray(f(this).closest('tr').get(0), i.rows().nodes().toArray())) {
                ...
                'click' === e.type
                  ...
                  : 'mouseup' === e.type && f(this).trigger('blur').css('outline', '');
              }
            });
        },
        ...
        _resize: function (n) {
          ...
          t
            ...
            h &&
              ...
              0 === t.page.info().recordsDisplay && f('td', t.table().body()).eq(0).attr('colspan', p)),
            i._controlClass();
        },
        _resizeAuto: function () {
          ...
          this.c.auto &&
            ...
            (r = f('<div/>').css({ width: 1, height: 1, overflow: 'hidden', clear: 'both' }).append(e)).insertBefore(s.table().node()),
            n.each(function (e) {
        ...
        _tabIndexes: function () {
          ...
          t.filter('[data-dtr-keyboard]').removeData('[data-dtr-keyboard]'),
            ('number' == typeof i
              ...
              : f((i = 'td:first-child, th:first-child' === i ? '>td:first-child, >th:first-child' : i), e.rows({ page: 'current' }).nodes())
            )
                    ...
                    s = f('<div class="dtr-modal"/>')
                      .append(
                        f('<div class="dtr-modal-display"/>')
                          .append(f('<div class="dtr-modal-content"/>').data('dtr-row-idx', e.index()).append(n()))
                          .append(
                            f('<div class="dtr-modal-close">&times;</div>').click(function () {
                              r();
                            })
                          )
                      )
                      .append(
                        f('<div class="dtr-modal-background"/>').click(function () {
                          r();
                        })
                      )
                      .appendTo('body');
                ...
                f.each(t, function (e, t) {
                  ...
                  t.hidden &&
                    ...
                    f(
                      ...
                      .append(f('<span class="dtr-data"/>').append(r._childNodes(i, t.rowIndex, t.columnIndex)))
                      .appendTo(s),
                    (o = !0));
                });
                return !!o && s;
  ...
  return (
    ...
    f(d).on('preInit.dt.dtr', function (e, t, n) {
      'dt' === e.namespace &&
        (f(t.nTable).hasClass('responsive') || f(t.nTable).hasClass('dt-responsive') || t.oInit.responsive || r.defaults.responsive) &&
