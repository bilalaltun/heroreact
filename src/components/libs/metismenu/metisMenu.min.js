...
!(function (e, t) {
  'object' == typeof exports && 'undefined' != typeof module
    ...
    ? define(['jquery'], t)
    : ((e = 'undefined' != typeof globalThis ? globalThis : e || self).metisMenu = t(e.$));
})(this, function (e) {
  'use strict';
  function t(e) {
  ...
  const i = ((e) => {
    ...
    r = 'metisMenu',
    a = n.default.fn[s],
    o = { toggle: !0, preventDefault: !0, triggerElement: 'a', parentTrigger: 'li', subMenu: 'ul' },
    l = { SHOW: 'show.metisMenu', SHOWN: 'shown.metisMenu', HIDE: 'hide.metisMenu', HIDDEN: 'hidden.metisMenu', CLICK_DATA_API: 'click.metisMenu.data-api' },
    d = 'metismenu',
    g = 'mm-active',
    h = 'mm-show',
    u = 'mm-collapse',
        ...
        i
          ...
          .on(l.CLICK_DATA_API, function (i) {
            ...
            r.hasClass(g)
              ...
              : (s.attr('aria-expanded', 'true'), e.setActive(r), t.toggle && (e.removeActive(a), o.attr('aria-expanded', 'false'))),
  ...
  return (
    (n.default.fn[s] = c.jQueryInterface), (n.default.fn[s].Constructor = c), (n.default.fn[s].noConflict = () => ((n.default.fn[s] = a), c.jQueryInterface)), c
  );
});
