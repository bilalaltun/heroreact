        ...
        return (
          ...
          (e.prototype.tokenizer = function (e, t, n, s) {
            for (
              ...
              var l = o[r];
              -1 !== i.indexOf(l)
                ? ((l = o.substr(0, r)), null != (l = a(c.extend({}, t, { term: l }))) ? (s(l), (o = o.substr(r + 1) || ''), (r = 0)) : r++)
                : r++;
            }
            return { term: o };
          }),
      ...
      u.define('select2/core', ['jquery', './options', './utils', './keys'], function (t, i, o, s) {
        ...
        return (
          ...
          (r.prototype._generateId = function (e) {
            return (
              'select2-' +
              (null != e.attr('id') ? e.attr('id') : null != e.attr('name') ? e.attr('name') + '-' + o.generateChars(2) : o.generateChars(4)).replace(
                /(:|\.|\[|\]|,)/g,
                ''
              )
            );
      ...
      (a = function (u) {
        ...
        function s(e) {
          ...
          if (
            ...
            return (
              1 === n.deltaMode
                ? ((i *= t = u.data(this, 'mousewheel-line-height')), (r *= t), (o *= t))
                : 2 === n.deltaMode && ((i *= t = u.data(this, 'mousewheel-page-height')), (r *= t), (o *= t)),
              ...
              f.settings.normalizeOffset &&
                ...
                ((a = this.getBoundingClientRect()), (l = e.clientX - a.left), (c = e.clientY - a.top)),
              (e.deltaX = o),
              (e.deltaY = r),
              (e.deltaFactor = p),
              (e.offsetX = l),
