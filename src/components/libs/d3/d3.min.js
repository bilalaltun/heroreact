!(function () {
  ...
  function Zr(n, t, e, r) {
    n !== t
      ? (n - t > 180 ? (t += 360) : t - n > 180 && (n += 360), r.push({ i: e.push(Ir(e) + 'rotate(', null, ')') - 2, x: yr(n, t) }))
  ...
  function ju(n) {
    for (var t, e, r, i, u = [], o = Uu(n), a = -1, l = n.length - 1; ++a < l; )
      (t = Pu(n[a], n[a + 1])),
        xo(t) < Uo
          ? (o[a] = o[a + 1] = 0)
          : ((e = o[a] / t), (r = o[a + 1] / t), (i = e * e + r * r), i > 9 && ((i = (3 * t) / Math.sqrt(i)), (o[a] = i * e), (o[a + 1] = i * r)));
      ...
      insert: function (n, t) {
        ...
        for (t.L = t.R = null, t.U = e, t.C = !0, n = t; e && e.C; )
          (r = e.U),
            e === r.L
              ? ((i = r.R),
                i && i.C ? ((e.C = i.C = !1), (r.C = !0), (n = r)) : (n === e.R && (ir(this, e), (n = e), (e = n.U)), (e.C = !1), (r.C = !0), ur(this, r)))
              : ((i = r.L),
                i && i.C ? ((e.C = i.C = !1), (r.C = !0), (n = r)) : (n === e.L && (ur(this, e), (n = e), (e = n.U)), (e.C = !1), (r.C = !0), ir(this, r))),
            (e = n.U);
        this._.C = !1;
      },
      remove: function (n) {
  ...
  (ao.layout.histogram = function () {
    function n(n, u) {
      for (
        var o, a, l = [], c = n.map(e, this), f = r.call(this, c, u), s = i.call(this, f, c, u), u = -1, h = c.length, p = s.length - 1, g = t ? 1 : 1 / h;
        ++u < p;
      ...
      function t(n) {
        for (var t, e = { A: null, children: [n] }, r = [e]; null != (t = r.pop()); )
          for (var i, u = t.children, o = 0, a = u.length; a > o; ++o)
            r.push(
              ((u[o] = i =
                { _: u[o], parent: t, children: ((i = u[o].children) && i.slice()) || [], A: null, a: null, z: 0, m: 0, c: 0, s: 0, t: null, i: o }).a = i)
            );
        return e.children[0];
      }
      function e(n) {
  ...
  var Al = [2062260, 16744206, 2924588, 14034728, 9725885, 9197131, 14907330, 8355711, 12369186, 1556175].map(xn),
    Cl = [
      2062260, 11454440, 16744206, 16759672, 2924588, 10018698, 14034728, 16750742, 9725885, 12955861, 9197131, 12885140, 14907330, 16234194, 8355711, 13092807,
      12369186, 14408589, 1556175, 10410725,
    ].map(xn),
    zl = [
      3750777, 5395619, 7040719, 10264286, 6519097, 9216594, 11915115, 13556636, 9202993, 12426809, 15186514, 15190932, 8666169, 11356490, 14049643, 15177372,
      8077683, 10834324, 13528509, 14589654,
    ].map(xn),
    Ll = [
      3244733, 7057110, 10406625, 13032431, 15095053, 16616764, 16625259, 16634018, 3253076, 7652470, 10607003, 13101504, 7695281, 10394312, 12369372, 14342891,
      ...
      (n.extent = function (t) {
        ...
        return arguments.length
          ...
          : (c &&
              (o
                ? ((e = o[0]), (r = o[1]))
                : ((e = s[0]), (r = s[1]), c.invert && ((e = c.invert(e)), (r = c.invert(r))), e > r && ((l = e), (e = r), (r = l)))),
            f &&
              (a
                ? ((i = a[0]), (u = a[1]))
                : ((i = h[0]), (u = h[1]), f.invert && ((i = f.invert(i)), (u = f.invert(u))), i > u && ((l = i), (i = u), (u = l)))),
            c && f
              ? [
                  [e, i],
                  [r, u],
