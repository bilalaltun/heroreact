  ...
  i.prototype = {
    ...
    buttonBefore: function (e) {
      if (e === !0)
        this.options.buttonBefore ||
          ((this.options.buttonBefore = e), this.options.input && (this.$elementFilestyle.remove(), this.constructor(), this.pushNameFiles()));
      else {
    ...
    size: function (e) {
      ...
      t.removeClass('btn-lg btn-sm'),
        ...
        'nr' != this.options.size && (t.addClass('btn-' + this.options.size), i.addClass('form-control-' + this.options.size));
    },
    ...
    btnClass: function (e) {
      return void 0 === e
        ...
        : ((this.options.btnClass = e),
          void this.$elementFilestyle.find('label').attr({ class: 'btn ' + this.options.btnClass + ' btn-' + this.options.size }));
    },
    badge: function (e) {
      if (e === !0) {
    ...
    badgeName: function (e) {
      return void 0 === e
        ...
        : ((this.options.badgeName = e), void this.$elementFilestyle.find('.badge').attr({ class: 'badge ' + this.options.badgeName }));
    },
    htmlIcon: function (e) {
    ...
    constructor: function () {
      ...
      ('' !== s && s) || ((s = 'filestyle-' + t), i.$element.attr({ id: s }), t++),
        ...
        (i.$elementFilestyle = e('<div class="bootstrap-filestyle input-group"><div name="filedrag"></div>' + n + '</div>')),
        i.$elementFilestyle
        ...
        i.$elementFilestyle.find('[name="filedrag"]').css({ position: 'absolute', width: '100%', height: i.$elementFilestyle.height() + 'px', 'z-index': -1 }),
        (i.options.disabled || i.$element.attr('disabled')) &&
          (i.$element.attr('disabled', 'true'),
          i.options.disabled ? i.$elementFilestyle.find('label').css('opacity', '0.65') : i.$elementFilestyle.find('label').css('opacity', '1')),
        i.$element.change(function () {
          var e = i.pushNameFiles();
          i.options.badge
            ? 0 == i.$elementFilestyle.find('.badge').length
              ? i.$elementFilestyle.find('label').append(' <span class="badge ' + i.options.badgeName + '">' + e.length + '</span>')
              : 0 == e.length
        ...
        i.$elementFilestyle
          ...
          .on('drop', function (t) {
            if (t.originalEvent.dataTransfer && !i.options.disabled && i.options.dragdrop && t.originalEvent.dataTransfer.files.length) {
              ...
              i.options.badge
                ? 0 == i.$elementFilestyle.find('.badge').length
                  ? i.$elementFilestyle.find('label').append(' <span class="badge ' + i.options.badgeName + '">' + n.length + '</span>')
                  : 0 == n.length
                  ? i.$elementFilestyle.find('.badge').remove()
