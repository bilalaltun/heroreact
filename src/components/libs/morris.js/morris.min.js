      ...
      function d(b) {
        ...
        'static' === this.el.css('position') && this.el.css('position', 'relative'),
          ...
          this.el.bind('touchstart touchmove touchend', function (a) {
            var b, d;
            return (
              (d = a.originalEvent.touches[0] || a.originalEvent.changedTouches[0]), (b = c.el.offset()), c.fire('hovermove', d.pageX - b.left, d.pageY - b.top)
            );
          }),
      ...
      return (
        ...
        (d.prototype.redraw = function () {
          ...
          for (
            ...
            (m = u[o]), (l += m);
          for (
            i = 5 / (2 * n), a = 1.9999 * Math.PI - i * this.data.length, g = 0, f = 0, this.segments = [], v = this.values, e = p = 0, s = v.length;
            s > p;
            e = ++p
          )
            (m = v[e]),
