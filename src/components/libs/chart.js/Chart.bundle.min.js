...
!(function (t, e) {
  ...
  Y._set('global', {
    elements: {
      point: { radius: 3, pointStyle: 'circle', backgroundColor: ft, borderColor: ft, borderWidth: 1, hitRadius: 1, hoverRadius: 4, hoverBorderWidth: 1 },
    },
  });
  var mt = X.extend({
      _type: 'point',
  ...
  var At = at.extend({
      ...
      _getStacks: function (t) {
        ...
        for (
          e = 0;
          e < o && ((n = a[e]), (!1 === r || -1 === s.indexOf(n.stack) || (void 0 === r && void 0 === n.stack)) && s.push(n.stack), n.index !== t);
          ++e
        );
        return s;
      },
  ...
  B.extend(en.prototype, {
    ...
    buildOrUpdateControllers: function () {
      ...
      for (t = 0, e = a.length; t < e; t++) {
        ...
        if (
          (o.type && o.type !== s && (n.destroyDatasetMeta(t), (o = n.getDatasetMeta(t))), (o.type = s), (o.order = r.order || 0), (o.index = t), o.controller)
        )
                      ...
                      ? (function (t) {
                          ...
                          for (a = 0; a < t._f.length; a++)
                            (r = 0),
                              ...
                              Ae(e),
                              m(e) &&
                                ((r += g(e).charsLeftOver), (r += 10 * g(e).unusedTokens.length), (g(e).score = r), (null == i || r < i) && ((i = r), (n = e)));
                          c(t, n || e);
                        })(t)
                      : n
                      ? Ae(t)
                      : (function (t) {
                          ...
                          s(e)
                            ...
                            ? (function (t) {
                                ...
                                null === e
                                  ? (De(t),
                                    !1 === t._isValid && (delete t._isValid, Oe(t), !1 === t._isValid && (delete t._isValid, a.createFromInputFallback(t))))
                                  : (t._d = new Date(+e[1]));
                              })(t)
                            : r(e)
      ...
      (B.splineCurveMonotone = function (t) {
        ...
        for (e = 0; e < h; ++e)
          (i = d[e]).model.skip ||
            ...
            a &&
              !a.model.skip &&
              ((u = (a.model.x - i.model.x) / 3), (i.model.controlPointNextX = i.model.x + u), (i.model.controlPointNextY = i.model.y + u * i.mK)));
      }),
