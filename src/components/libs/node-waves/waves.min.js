!(function (t, e) {
  ...
  function a(t) {
    ...
    return '[object String]' === e
      ? d(t)
      : n(t) && /^\[object (Array|HTMLCollection|NodeList|Object)\]$/.test(e) && t.hasOwnProperty('length')
      ? t
      : o(t)
      ? [t]
      : [];
  ...
  function c(t) {
    ...
    if (null !== e) {
      ...
      if ((h.registerEvent(t), 'touchstart' === t.type && v.delay)) {
        ...
        v.show(t, e),
          m && (e.addEventListener('touchend', v.hide, !1), e.addEventListener('touchcancel', v.hide, !1)),
  ...
  var l = l || {},
    ...
    v = {
      ...
      hide: function (t, e) {
        ...
        m && (e.removeEventListener('touchend', v.hide), e.removeEventListener('touchcancel', v.hide)),
