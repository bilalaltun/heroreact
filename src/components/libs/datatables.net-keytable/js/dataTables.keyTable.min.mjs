...
var namespaceCounter = 0,
  editorNamespaceCounter = 0,
  KeyTable = function (e, t) {
    if (!DataTable.versionCheck || !DataTable.versionCheck('1.10.8')) throw 'KeyTable requires DataTables 1.10.8 or newer';
    (this.c = $.extend(!0, {}, DataTable.defaults.keyTable, KeyTable.defaults, t)),
      (this.s = {
        dt: new DataTable.Api(e),
        dtDrawing: !1,
        enable: !0,
        focusDraw: !1,
        waitingForDraw: !1,
      ...
      (this.dom = {});
    (t = this.s.dt.settings()[0]), (e = t.keytable);
    if (e) return e;
...
$.extend(KeyTable.prototype, {
  ...
  _constructor: function () {
    ...
    var i,
      ...
      n =
        ...
        $(s.table().body()).on('click' + l, 'th, td', function (e) {
          var t;
          !1 !== o.s.enable && (t = s.cell(this)).any() && o._focus(t, null, !1, e);
        }),
        $(document).on('keydown' + l, function (e) {
          t || o.s.dtDrawing ? e.preventDefault() : o._key(e);
        }),
        this.c.blurable &&
          $(document).on('mousedown' + l, function (e) {
            $(e.target).parents('.dataTables_filter, .dt-search').length && o._blur(),
              $(e.target).parents().filter(s.table().container()).length ||
                $(e.target).parents('div.DTE').length ||
                $(e.target).parents('div.editor-datetime').length ||
                $(e.target).parents('div.dt-datetime').length ||
                $(e.target).parents().filter('.DTFC_Cloned').length ||
                o._blur();
          }),
        this.c.editor &&
          ...
          $(s.table().body()).on('dblclick' + l, 'th, td', function (e) {
  ...
  _blur: function (e) {
    ...
    this.s.enable &&
      ...
      $(t.node()).removeClass(this.c.className),
    ...
    window.getSelection &&
      ...
      $(document).on('paste' + e, function (e) {
        ...
        !n ||
          ...
          s ? ((i = l._inlineOptions(n.cell.index())), s.inline(i.cell, i.field, i.options).set(s.displayed()[0], t).submit()) : (n.cell.data(t), o.draw(!1)));
      }));
  },
  _columns: function () {
    var e = this.s.dt,
  ...
  _editor: function (e, t, n) {
    ...
    !this.s.lastFocus ||
      ...
      (a = this.s.namespace + 'e' + editorNamespaceCounter++),
      $('div.DTE', l.node()).length ||
        (null !== e && ((0 <= e && e <= 9) || 11 === e || 12 === e || (14 <= e && e <= 31) || (112 <= e && e <= 123) || (127 <= e && e <= 159))) ||
        (t && (t.stopPropagation(), 13 === e && t.preventDefault()),
        (r = function () {
          var e = i._inlineOptions(l.index());
          o.one('open' + a, function () {
            o.off('cancelOpen' + a),
              n || $('div.DTE_Field_InputControl input, div.DTE_Field_InputControl textarea').select(),
              ...
              n && $(s.table().container()).addClass('dtk-focus-alt'),
              ...
              o.one('close' + a, function () {
                s.keys.enable(!0),
                  ...
                  o.off(a),
                  $(s.table().container()).removeClass('dtk-focus-alt'),
  ...
  _emitEvent: function (n, i) {
    return this.s.dt.iterator('table', function (e, t) {
      return $(e.nTable).triggerHandler(n, i);
    });
  },
  _focus: function (e, t, n, i) {
    ...
    if (((i = i || null), this.s.enable)) {
      if ('number' != typeof e) {
        if (!e.any()) return;
        var r = e.index();
        if (((t = r.column), (e = o.rows({ filter: 'applied', order: 'applied' }).indexes().indexOf(r.row)) < 0)) return;
      ...
      if (-1 !== l.length && (e < l.start || e >= l.start + l.length))
        (this.s.focusDraw = !0),
          ...
          o
            ...
            .draw(!1);
      else if (-1 !== $.inArray(t, this._columns())) {
        l.serverSide && (e -= l.start);
        ...
        if (-1 === r.indexOf(!1)) {
          ...
          (r = $(l.node())),
            (a =
              ...
              (void 0 !== n && !0 !== n) ||
                (this._scroll($(window), $(document.body), r, 'offset'),
                (a = o.table().body().parentNode) !== o.table().header().parentNode && ((n = $(a.parentNode)), this._scroll(n, n, r, 'position'))),
              o.page.info()));
          (this.s.lastFocus = {
            cell: l,
            node: l.node(),
            relative: { row: a.start + o.rows({ page: 'current' }).indexes().indexOf(l.index().row), column: l.index().column },
          }),
  ...
  _key: function (n) {
    ...
    else if (!$(n.target).closest('.dte-inlineAdd').length) {
      var e = this.s.enable,
      ...
      if (e && (!(0 === n.keyCode || n.ctrlKey || n.metaKey || n.altKey) || (n.ctrlKey && n.altKey))) {
        ...
        if (i)
          if (this.s.dt.cell(i.node).any()) {
            ...
            if (!this.c.keys || -1 !== $.inArray(n.keyCode, this.c.keys))
              switch (n.keyCode) {
                case 9:
                  n.preventDefault(),
  ...
  _removeOtherFocus: function () {
    ...
    $.fn.dataTable.tables({ api: !0 }).iterator('table', function (e) {
  ...
  _shift: function (e, t, n) {
    ...
    !r ||
      ((r = r.cell) &&
        ...
        'rtl' === $(s.table().node()).css('direction') && ('right' === t ? (t = 'left') : 'left' === t && (t = 'right')),
        'right' === t
  ...
  _tabInput: function () {
    ...
    -1 != e &&
      (this.s.tabInput ||
        ((e = $('<div><input type="text" tabindex="' + e + '"/></div>').css({ position: 'absolute', height: 1, width: 0, overflow: 'hidden' }))
          .children()
          .on('focus', function (e) {
        ...
        (this.s.tabInput = e)),
      (e = this.s.dt.cell(':eq(0)', '0:visible', { page: 'current', order: 'current' }).node()) && $(e).prepend(this.s.tabInput));
  },
  _updateFixedColumns: function (e) {
    var t,
      ...
      i = n.settings()[0];
    i._oFixedColumns &&
      ((t = i._oFixedColumns.s.iLeftColumns), (i = i.aoColumns.length - i._oFixedColumns.s.iRightColumns), (e < t || i <= e) && n.fixedColumns().update());
  },
}),
  (KeyTable.defaults = {
    blurable: !0,
  ...
  DataTable.Api.register('keys.enable()', function (t) {
    return this.iterator('table', function (e) {
      e.keytable && e.keytable.enable(void 0 === t || t);
    });
  }),
  DataTable.Api.register('keys.enabled()', function (e) {
    var t = this.context;
    return !!t.length && !!t[0].keytable && t[0].keytable.enabled();
  }),
  DataTable.Api.register('keys.move()', function (t) {
    return this.iterator('table', function (e) {
      e.keytable && e.keytable._shift(null, t, !1);
    });
  }),
  DataTable.ext.selector.cell.push(function (e, t, n) {
    var i = t.focused,
      s = e.keytable,
      o = [];
    if (!s || void 0 === i) return n;
    for (var l = 0, a = n.length; l < a; l++) ((!0 === i && s.focused(n[l])) || (!1 === i && !s.focused(n[l]))) && o.push(n[l]);
    return o;
  }),
  $(document).on('preInit.dt.dtk', function (e, t, n) {
    var i;
    'dt' === e.namespace && ((e = t.oInit.keys), (i = DataTable.defaults.keys), (e || i) && ((i = $.extend({}, i, e)), !1 !== e && new KeyTable(t, i)));
  });
