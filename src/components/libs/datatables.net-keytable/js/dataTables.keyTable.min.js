...
!(function (n) {
  ...
  'use strict';
  function s(e, t) {
    if (!o.versionCheck || !o.versionCheck('1.10.8')) throw 'KeyTable requires DataTables 1.10.8 or newer';
    if (
  ...
  return (
    c.extend(s.prototype, {
        ...
        u.getSelection &&
          ...
          c(d).on('paste' + e, function (e) {
            ...
            !n ||
              ...
              s
                ? ((i = l._inlineOptions(n.cell.index())), s.inline(i.cell, i.field, i.options).set(s.displayed()[0], t).submit())
      ...
      _inlineOptions: function (e) {
        return this.c.editorOptions ? this.c.editorOptions(e) : { cell: e, field: f, options: f };
      },
        ...
        if (((i = i || null), this.s.enable)) {
          ...
          if (-1 !== l.length && (e < l.start || e >= l.start + l.length))
            (this.s.focusDraw = !0),
              ...
              o
                .one('draw', function () {
                  (s.s.focusDraw = !1), (s.s.waitingForDraw = !1), s._focus(e, t, f, i);
                })
              ...
              (r = c(l.node())),
                (a =
                  ...
                  (n !== f && !0 !== n) ||
                    ...
                    (a = o.table().body().parentNode) !== o.table().header().parentNode && ((n = c(a.parentNode)), this._scroll(n, n, r, 'position'))),
                  o.page.info()));
              (this.s.lastFocus = {
                cell: l,
                node: l.node(),
      ...
      _shift: function (e, t, n) {
        ...
        !r ||
          ((r = r.cell) &&
            ...
            'rtl' === c(s.table().node()).css('direction') && ('right' === t ? (t = 'left') : 'left' === t && (t = 'right')),
            'right' === t
    ...
    c(d).on('preInit.dt.dtk', function (e, t, n) {
      var i;
      'dt' === e.namespace && ((e = t.oInit.keys), (i = o.defaults.keys), (e || i) && ((i = c.extend({}, i, e)), !1 !== e && new s(t, i)));
    }),
    o
  );
});
