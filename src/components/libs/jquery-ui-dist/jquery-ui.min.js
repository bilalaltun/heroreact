...
!(function (t) {
    ...
    (V.position = {
      scrollbarWidth: function () {
        ...
        var t,
          ...
          i = e.children()[0];
        return (
          V('body').append(e), (t = i.offsetWidth), e.css('overflow', 'scroll'), t === (i = i.offsetWidth) && (i = e[0].clientWidth), e.remove(), (s = t - i)
        );
      },
      ...
      return (
        ...
        V.each(['my', 'at'], function () {
          var t,
            e,
            i = (u[this] || '').split(' ');
          ((i = 1 === i.length ? (o.test(i[0]) ? i.concat(['center']) : l.test(i[0]) ? ['center'].concat(i) : ['center', 'center']) : i)[0] = o.test(i[0])
            ? i[0]
            : 'center'),
        ...
        return (
          w(i.props, function (t, e) {
            var i = e.idx,
              ...
              o = v[e.type] || {};
            null !== n &&
              (null === s ? (l[i] = n) : (o.mod && (n - s > o.mod / 2 ? (s += o.mod) : s - n > o.mod / 2 && (s -= o.mod)), (l[i] = M((n - s) * a + s, e))));
          }),
          this[e](l)
        );
      },
  ...
  function G(t, e) {
    var i = e.outerWidth(),
      e = e.outerHeight(),
      t = /^rect\((-?\d*\.?\d*px|-?\d+%|auto),?\s*(-?\d*\.?\d*px|-?\d+%|auto),?\s*(-?\d*\.?\d*px|-?\d+%|auto),?\s*(-?\d*\.?\d*px|-?\d+%|auto)\)$/.exec(t) || [
        '',
        0,
        i,
        e,
  ...
  (y = V.effects),
    ...
    V.effects.define('scale', function (t, e) {
      var i = V(this),
        ...
        s = V.extend(
          !0,
          { from: V.effects.scaledDimensions(i), to: V.effects.scaledDimensions(i, s, t.direction || 'both'), origin: t.origin || ['middle', 'center'] },
          t
        );
  ...
  V.widget('ui.autocomplete', {
    ...
    _appendTo: function () {
      ...
      return (t = !(t = !(t = t && (t.jquery || t.nodeType ? V(t) : this.document.find(t).eq(0))) || !t[0] ? this.element.closest('.ui-front, dialog') : t)
        .length
  ...
  V.widget('ui.controlgroup', {
    ...
    _buildSimpleOptions: function (t, e) {
      var i = 'vertical' === this.options.direction,
        s = { classes: {} };
      return (
        (s.classes[e] = { middle: '', first: 'ui-corner-' + (i ? 'top' : 'left'), last: 'ui-corner-' + (i ? 'bottom' : 'right'), only: 'ui-corner-all' }[t]), s
      );
    },
  ...
  V.extend(V.ui, { datepicker: { version: '1.13.2' } }),
    V.extend(st.prototype, {
      ...
      _selectDate: function (t, e) {
        ...
        (e = null != e ? e : this._formatDate(t)),
          ...
          t.inline
            ...
            : (this._hideDatepicker(), (this._lastInput = t.input[0]), 'object' != typeof t.input[0] && t.input.trigger('focus'), (this._lastInput = null));
      },
      ...
      parseDate: function (e, n, t) {
        ...
        if (
          (-1 === d ? (d = new Date().getFullYear()) : d < 100 && (d += new Date().getFullYear() - (new Date().getFullYear() % 100) + (d <= r ? 0 : -100)),
          -1 < g)
        )
          for (p = 1, f = g; ; ) {
              ...
              for (w += '<tr>', M = o ? "<td class='ui-datepicker-week-col'>" + this._get(t, 'calculateWeek')(T) + '</td>' : '', g = 0; g < 7; g++)
                (S = c ? c.apply(t.input ? t.input[0] : null, [T]) : [!0, '']),
                  ...
                  (M +=
                    ...
                    ((T.getTime() === b.getTime() && K === t.selectedMonth && t._keyEvent) || (p.getTime() === T.getTime() && p.getTime() === b.getTime())
                      ? ' ' + this._dayOverClass
                      : '') +
  ...
  V.widget('ui.resizable', V.ui.mouse, {
    ...
    _mouseStop: function (t) {
      ...
      return (
        this._helper &&
          ((s =
            (e = (i = this._proportionallyResizeElements).length && /textarea/i.test(i[0].nodeName)) && this._hasScroll(i[0], 'left') ? 0 : o.sizeDiff.height),
    ...
    V.widget('ui.selectmenu', [
      V.ui.formResetMixin,
      {
        ...
        _setSelection: function () {
          var t;
          this.range &&
            (window.getSelection ? ((t = window.getSelection()).removeAllRanges(), t.addRange(this.range)) : this.range.select(), this.button.trigger('focus'));
        },
        _documentClick: {
          mousedown: function (t) {
          ...
          return (
            ...
            this.options.revert
              ? ((s = (i = this).placeholder.offset()),
                ...
                (n && 'y' !== n) ||
                  (o.top =
                    s.top - this.offset.parent.top - this.margins.top + (this.offsetParent[0] === this.document[0].body ? 0 : this.offsetParent[0].scrollTop)),
                (this.reverting = !0),
          ...
          for (e = u.length - 1; 0 <= e; e--)
            for (i = (s = V(u[e], this.document[0])).length - 1; 0 <= i; i--)
              (n = V.data(s[i], this.widgetFullName)) &&
                ...
                !n.options.disabled &&
                (c.push([
                  'function' == typeof n.options.items ? n.options.items.call(n.element[0], t, { item: this.currentItem }) : V(n.options.items, n.element),
                  n,
                ]),
            ...
            update: function (t, e) {
              (s && !o.forcePlaceholderSize) ||
                ((e.height() && (!o.forcePlaceholderSize || ('tbody' !== n && 'tr' !== n))) ||
                  e.height(
                    i.currentItem.innerHeight() - parseInt(i.currentItem.css('paddingTop') || 0, 10) - parseInt(i.currentItem.css('paddingBottom') || 0, 10)
                  ),
                e.width() ||
                  e.width(
                    i.currentItem.innerWidth() - parseInt(i.currentItem.css('paddingLeft') || 0, 10) - parseInt(i.currentItem.css('paddingRight') || 0, 10)
                  ));
            },
          })),
  ...
  V.widget('ui.spinner', {
    ...
    _parse: function (t) {
      return '' ===
        (t = 'string' == typeof t && '' !== t ? (window.Globalize && this.options.numberFormat ? Globalize.parseFloat(t, 10, this.options.culture) : +t) : t) ||
        isNaN(t)
        ? null
        : t;
    },
  ...
  V.widget('ui.tabs', {
    ...
    _activate: function (t) {
      ...
      t[0] !== this.active[0] &&
        ((t = (t = !t.length ? this.active : t).find('.ui-tabs-anchor')[0]), this._eventHandler({ target: t, currentTarget: t, preventDefault: V.noop }));
    },
    _findActive: function (t) {
