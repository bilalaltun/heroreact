!(function (e, a) {
  ...
  var d = { 1: '\u0661', 2: '\u0662', 3: '\u0663', 4: '\u0664', 5: '\u0665', 6: '\u0666', 7: '\u0667', 8: '\u0668', 9: '\u0669', 0: '\u0660' },
    t = {
      '\u0661': '1',
      '\u0662': '2',
      '\u0663': '3',
  ...
  function Y(e, a, _) {
    ...
    return 'm' === _
      ...
      : e +
        ...
        s % 10 == 1 && s % 100 != 11 ? d[0] : 2 <= s % 10 && s % 10 <= 4 && (s % 100 < 10 || 20 <= s % 100) ? d[1] : d[2]);
  }
  e.defineLocale('az', {
  ...
  var h = { 1: '\u09e7', 2: '\u09e8', 3: '\u09e9', 4: '\u09ea', 5: '\u09eb', 6: '\u09ec', 7: '\u09ed', 8: '\u09ee', 9: '\u09ef', 0: '\u09e6' },
    y = {
      '\u09e7': '1',
      '\u09e8': '2',
      '\u09e9': '3',
  ...
  var c = { 1: '\u0f21', 2: '\u0f22', 3: '\u0f23', 4: '\u0f24', 5: '\u0f25', 6: '\u0f26', 7: '\u0f27', 8: '\u0f28', 9: '\u0f29', 0: '\u0f20' },
    k = {
      '\u0f21': '1',
      '\u0f22': '2',
      '\u0f23': '3',
  ...
  function p(e, a, _) {
    ...
    return (
      ...
      2 !== e ? s : void 0 !== (t = { m: 'v', b: 'v', d: 'z' })[(d = s).charAt(0)] ? t[d.charAt(0)] + d.substring(1) : d)
    );
  }
  function D(e, a, _) {
    var s = e + ' ';
  ...
  e.defineLocale('cs', {
    ...
    relativeTime: { future: 'za %s', past: 'p\u0159ed %s', s: b, ss: b, m: b, mm: b, h: b, hh: b, d: b, dd: b, M: b, MM: b, y: b, yy: b },
    dayOfMonthOrdinalParse: /\d{1,2}\./,
    ordinal: '%d.',
    week: { dow: 1, doy: 4 },
  }),
    ...
    e.defineLocale('el', {
      ...
      calendar: function (e, a) {
        var _,
          ...
          d = a && a.hours();
        return (
          ((_ = s) instanceof Function || '[object Function]' === Object.prototype.toString.call(_)) && (s = s.apply(a)),
  ...
  e.defineLocale('es', {
    ...
    e.defineLocale('et', {
      ...
      relativeTime: { future: '%s p\xe4rast', past: '%s tagasi', s: G, ss: G, m: G, mm: G, h: G, hh: G, d: G, dd: '%d p\xe4eva', M: G, MM: G, y: G, yy: G },
      dayOfMonthOrdinalParse: /\d{1,2}\./,
      ordinal: '%d.',
      week: { dow: 1, doy: 4 },
    }),
  ...
  e.defineLocale('fi', {
    ...
    relativeTime: { future: '%s p\xe4\xe4st\xe4', past: '%s sitten', s: Q, ss: Q, m: Q, mm: Q, h: Q, hh: Q, d: Q, dd: Q, M: Q, MM: Q, y: Q, yy: Q },
    dayOfMonthOrdinalParse: /\d{1,2}\./,
    ordinal: '%d.',
    week: { dow: 1, doy: 4 },
  }),
  ...
  e.defineLocale('gd', {
    ...
    e.defineLocale('gom-latn', {
      ...
      relativeTime: { future: '%s', past: '%s adim', s: X, ss: X, m: X, mm: X, h: X, hh: X, d: X, dd: X, M: X, MM: X, y: X, yy: X },
      dayOfMonthOrdinalParse: /\d{1,2}(er)/,
      ordinal: function (e, a) {
        switch (a) {
          case 'D':
  ...
  var ee = { 1: '\u0ae7', 2: '\u0ae8', 3: '\u0ae9', 4: '\u0aea', 5: '\u0aeb', 6: '\u0aec', 7: '\u0aed', 8: '\u0aee', 9: '\u0aef', 0: '\u0ae6' },
    ae = {
      '\u0ae7': '1',
      '\u0ae8': '2',
      '\u0ae9': '3',
  ...
  var _e = { 1: '\u0967', 2: '\u0968', 3: '\u0969', 4: '\u096a', 5: '\u096b', 6: '\u096c', 7: '\u096d', 8: '\u096e', 9: '\u096f', 0: '\u0966' },
    se = {
      '\u0967': '1',
      '\u0968': '2',
      '\u0969': '3',
  ...
  e.defineLocale('hu', {
    ...
    relativeTime: { future: '%s m\xfalva', past: '%s', s: ne, ss: ne, m: ne, mm: ne, h: ne, hh: ne, d: ne, dd: ne, M: ne, MM: ne, y: ne, yy: ne },
    dayOfMonthOrdinalParse: /\d{1,2}\./,
    ordinal: '%d.',
    week: { dow: 1, doy: 4 },
  }),
  ...
  var ue = { 1: '\u17e1', 2: '\u17e2', 3: '\u17e3', 4: '\u17e4', 5: '\u17e5', 6: '\u17e6', 7: '\u17e7', 8: '\u17e8', 9: '\u17e9', 0: '\u17e0' },
    le = {
      '\u17e1': '1',
      '\u17e2': '2',
      '\u17e3': '3',
  ...
  var Me = { 1: '\u0ce7', 2: '\u0ce8', 3: '\u0ce9', 4: '\u0cea', 5: '\u0ceb', 6: '\u0cec', 7: '\u0ced', 8: '\u0cee', 9: '\u0cef', 0: '\u0ce6' },
    Le = {
      '\u0ce7': '1',
      '\u0ce8': '2',
      '\u0ce9': '3',
  ...
  var Ye = { 1: '\u0661', 2: '\u0662', 3: '\u0663', 4: '\u0664', 5: '\u0665', 6: '\u0666', 7: '\u0667', 8: '\u0668', 9: '\u0669', 0: '\u0660' },
    he = {
      '\u0661': '1',
      '\u0662': '2',
      '\u0663': '3',
  ...
  var Pe = { 1: '\u0967', 2: '\u0968', 3: '\u0969', 4: '\u096a', 5: '\u096b', 6: '\u096c', 7: '\u096d', 8: '\u096e', 9: '\u096f', 0: '\u0966' },
    We = {
      '\u0967': '1',
      '\u0968': '2',
      '\u0969': '3',
  ...
  var Oe = { 1: '\u1041', 2: '\u1042', 3: '\u1043', 4: '\u1044', 5: '\u1045', 6: '\u1046', 7: '\u1047', 8: '\u1048', 9: '\u1049', 0: '\u1040' },
    Ee = {
      '\u1041': '1',
      '\u1042': '2',
      '\u1043': '3',
  ...
  var Fe = { 1: '\u0967', 2: '\u0968', 3: '\u0969', 4: '\u096a', 5: '\u096b', 6: '\u096c', 7: '\u096d', 8: '\u096e', 9: '\u096f', 0: '\u0966' },
    ze = {
      '\u0967': '1',
      '\u0968': '2',
      '\u0969': '3',
  ...
  var qe = { 1: '\u0a67', 2: '\u0a68', 3: '\u0a69', 4: '\u0a6a', 5: '\u0a6b', 6: '\u0a6c', 7: '\u0a6d', 8: '\u0a6e', 9: '\u0a6f', 0: '\u0a66' },
    Ue = {
      '\u0a67': '1',
      '\u0a68': '2',
      '\u0a69': '3',
  ...
  function Xe(e, a, _) {
    var s = ' ';
    return (
      (20 <= e % 100 || (100 <= e && e % 100 == 0)) && (s = ' de '), e + s + { ss: 'secunde', mm: 'minute', hh: 'ore', dd: 'zile', MM: 'luni', yy: 'ani' }[_]
    );
  }
  function ea(e, a, _) {
    var s, d;
  ...
  e.defineLocale('sk', {
    ...
    relativeTime: { future: 'za %s', past: 'pred %s', s: ra, ss: ra, m: ra, mm: ra, h: ra, hh: ra, d: ra, dd: ra, M: ra, MM: ra, y: ra, yy: ra },
    dayOfMonthOrdinalParse: /\d{1,2}\./,
    ordinal: '%d.',
    week: { dow: 1, doy: 4 },
  }),
    e.defineLocale('sl', {
      ...
      relativeTime: { future: '\u010dez %s', past: 'pred %s', s: ia, ss: ia, m: ia, mm: ia, h: ia, hh: ia, d: ia, dd: ia, M: ia, MM: ia, y: ia, yy: ia },
      dayOfMonthOrdinalParse: /\d{1,2}\./,
      ordinal: '%d.',
      week: { dow: 1, doy: 7 },
    }),
  ...
  var ua = { 1: '\u0be7', 2: '\u0be8', 3: '\u0be9', 4: '\u0bea', 5: '\u0beb', 6: '\u0bec', 7: '\u0bed', 8: '\u0bee', 9: '\u0bef', 0: '\u0be6' },
    la = {
      '\u0be7': '1',
      '\u0be8': '2',
      '\u0be9': '3',
  ...
  e.defineLocale('tr', {
    ...
    e.defineLocale('tzl', {
      ...
      relativeTime: { future: 'osprei %s', past: 'ja%s', s: ya, ss: ya, m: ya, mm: ya, h: ya, hh: ya, d: ya, dd: ya, M: ya, MM: ya, y: ya, yy: ya },
      dayOfMonthOrdinalParse: /\d{1,2}\./,
      ordinal: '%d.',
      week: { dow: 1, doy: 4 },
    }),
