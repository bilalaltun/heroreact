...
!(function (o) {
  ...
  'use strict';
  function r(t, e) {
    if (!n.versionCheck || !n.versionCheck('1.10.8')) throw 'Warning: AutoFill requires DataTables 1.10.8 or greater';
    (this.c = m.extend(!0, {}, n.defaults.autoFill, r.defaults, e)),
      (this.s = { dt: new n.Api(t), namespace: '.autoFill' + o++, scroll: {}, scrollInterval: null, handle: { height: 0, width: 0 }, enabled: !1 }),
      (this.dom = {
        ...
        list: m('<div class="dt-autofill-list">' + this.s.dt.i18n('autoFill.info', '') + '</div>')
          .attr('aria-modal', !0)
          .attr('role', 'dialog')
    ...
    t =
      (m.extend(r.prototype, {
        ...
        enable: function (t) {
          ...
          function o() {
            (e.s.handle = { height: !1, width: !1 }), m(e.dom.handle).css({ height: '', width: '' }), e.dom.attachedTo !== b && e._attach(e.dom.attachedTo);
          }
          return (
        ...
        _attach: function (t) {
          ...
          o && -1 !== e.columns(this.c.columns).indexes().indexOf(o.column)
            ? (this.dom.offsetParent || (this.dom.offsetParent = m(e.table().node()).offsetParent()),
              ...
              i.css({ top: o.top + t.offsetHeight - n.height, left: o.left + t.offsetWidth - n.width }).appendTo(this.dom.offsetParent))
            : this._detach();
        },
              ...
              : (1 < a.length || this.c.alwaysAsk) &&
                ...
                m.each(a, function (t, e) {
                  i.append(
                    m('<button/>')
                      .html(s[e].option(l, o))
                      .append(m('<span class="dt-autofill-button"/>').html(l.i18n('autoFill.button', '&gt;')))
                      .on('click', function () {
                        var t = s[e].execute(l, o, m(this).closest('li'));
                        n._update(t, o), n.dom.background.remove(), n.dom.list.remove();
                      })
                  );
                }),
                ...
                this.c.closeButton &&
                  (this.dom.list.prepend(this.dom.closeButton).addClass(r.classes.closeable),
        ...
        _focusListenerRemove: function () {
          var t = this.s.dt;
          t.off('.autoFill'), m(t.table().body()).off(this.s.namespace), m(p.body).off(this.s.namespace);
        },
        ...
        _mousedown: function (t) {
          var e = this,
            ...
            i =
              ...
              (this.s.start = { row: o.rows({ page: 'current' }).nodes().indexOf(m(this.dom.start).parent()[0]), column: m(this.dom.start).index() }),
              m(p.body)
        ...
        _mouseup: function (t) {
          ...
          if (o.row !== i.row || o.column !== i.column) {
            ...
            if (m('div.DTE', s.node()).length)
              ...
              this._actionSelector(d), clearInterval(this.s.scrollInterval), (this.s.scrollInterval = null);
            }
          }
        },
        _range: function (t, e) {
          ...
          if (!1 !== t) {
            ...
            if ((this._emitEvent('preAutoFill', [t, e]), this._editor(e), null !== this.c.update ? this.c.update : !this.c.editor)) {
              for (var n = 0, l = e.length; n < l; n++)
                for (var s = 0, a = e[n].length; s < a; s++) (o = e[n][s]), -1 !== i.indexOf(o.index.column) && o.cell.data(o.set);
              t.draw(!1);
            }
        ...
        increment: {
          ...
          execute: function (t, e, o) {
            for (var i = +e[0][0].data, n = +m('input', o).val(), l = 0, s = e.length; l < s; l++)
              for (var a = 0, r = e[l].length; a < r; a++) (e[l][a].set = i), (i += n);
          },
        },
        fill: {
          available: function (t, e) {
          ...
          execute: function (t, e, o) {
            for (var i = e[0][0].data, n = 0, l = e.length; n < l; n++) for (var s = 0, a = e[n].length; s < a; s++) e[n][s].set = i;
          },
        },
        fillHorizontal: {
          available: function (t, e) {
          ...
          execute: function (t, e, o) {
            for (var i = 0, n = e.length; i < n; i++) for (var l = 0, s = e[i].length; l < s; l++) e[i][l].set = e[i][0].data;
          },
        },
        fillVertical: {
          available: function (t, e) {
          ...
          execute: function (t, e, o) {
            for (var i = 0, n = e.length; i < n; i++) for (var l = 0, s = e[i].length; l < s; l++) e[i][l].set = e[0][l].data;
          },
        },
        cancel: {
          available: function () {
      ...
      (r.version = '2.6.0'),
      (r.defaults = { alwaysAsk: !1, closeButton: !0, focus: null, columns: '', enable: !0, update: null, editor: null, vertical: !0, horizontal: !0 }),
  ...
  return (
    ...
    m(p).on('preInit.dt.autofill', function (t, e, o) {
      var i;
      'dt' === t.namespace && ((t = e.oInit.autoFill), (i = n.defaults.autoFill), (t || i) && ((i = m.extend({}, t, i)), !1 !== t && new r(e, i)));
    }),
    (n.AutoFill = r),
