...
!(function (n) {
          ...
          if ('table' != this.nodeName.toLowerCase()) W(null, 0, 'Non-table node initialisation (' + this.nodeName + ')', 2);
            ...
            var S = h.oFeatures,
              t = function () {
                ...
                if (
                  (0 === (n = 0 === n.length && 0 < e.length && ('' !== h.oScroll.sX || '' !== h.oScroll.sY) ? P('<tfoot/>').appendTo(l) : n).length ||
                  0 === n.children().length
  ...
  function st(t, e, n, a) {
    ...
    if (e)
      for (r = e.length - 1; 0 <= r; r--)
        for (
          var u, c = (u = e[r]).target !== H ? u.target : u.targets !== H ? u.targets : u.aTargets, f = 0, d = (c = Array.isArray(c) ? c : [c]).length;
          f < d;
          f++
        )
  ...
  function S(t, e, n, a) {
    ...
    if (s === H)
      return (
        t.iDrawError != r &&
          null === l &&
          (W(t, 0, 'Requested unknown parameter ' + ('function' == typeof o.mData ? '{function}' : "'" + o.mData + "'") + ' for row ' + e + ', column ' + n, 4),
          (t.iDrawError = r)),
        l
      );
  ...
  function vt(t, e) {
    ...
    n &&
      ...
      a.DT_RowClass &&
        ((t = a.DT_RowClass.split(' ')), (e.__rowc = e.__rowc ? z(e.__rowc.concat(t)) : t), P(n).removeClass(e.__rowc.join(' ')).addClass(a.DT_RowClass)),
  ...
  function yt(t) {
    ...
    for (i && (n = P('<tr/>').appendTo(r)), c = 0, f = s.length; c < f; c++)
      (a = s[c]),
        ...
        i && e.appendTo(n),
        t.oFeatures.bSort &&
          (e.addClass(a.sSortingClass), !1 !== a.bSortable && (e.attr('tabindex', t.iTabIndex).attr('aria-controls', t.sTableId), ue(t, a.nTh, c))),
  ...
  function Lt(n) {
    function e(t) {
      ...
      (o.return && 'Enter' !== t.key) ||
        (e != o.sSearch &&
          (Rt(n, { sSearch: e, bRegex: o.bRegex, bSmart: o.bSmart, bCaseInsensitive: o.bCaseInsensitive, return: o.return }), (n._iDisplayStart = 0), y(n)));
    }
    var t = n.oClasses,
      a = n.sTableId,
      r = n.oLanguage,
        ...
        return e === H
          ...
          : this.iterator('table', function (t) {
              t.oFeatures.bFilter &&
                Rt(
                  t,
                  P.extend({}, t.oPreviousSearch, { sSearch: e + '', bRegex: null !== n && n, bSmart: null === a || a, bCaseInsensitive: null === r || r }),
                  1
                );
            });
      }),
