              ...
              !(function (t) {
                (e[t] = Wt[t] =
                  function (r, i) {
                    return (
                      e.is(r, 'function') &&
                        ((this.events = this.events || []), this.events.push({ name: t, f: r, unbind: Dt(this.shape || this.node || l.doc, t, r, i || this) })),
                      this
                    );
                  }),
                  (e['un' + t] = Wt['un' + t] =
                        ...
                        case 'fill-opacity':
                          if (u.gradient) {
                            (z = t._g.doc.getElementById(l.getAttribute('fill').replace(/^url\(#|\)$/g, c))) &&
                              ((F = z.getElementsByTagName('stop')), x(F[F.length - 1], { 'stop-opacity': g }));
                            break;
                          }
                        default:
