        ...
        void 0 ===
          (n = function (t) {
            ...
            (e.color = function (t) {
              ...
              (e.rgb2hsb = function (t, e, r) {
                ...
                return (
                  ...
                  {
                    h:
                      ((((0 == (n = (i = w(t, e, r)) - k(t, e, r)) ? null : i == t ? (e - r) / n : i == e ? (r - t) / n + 2 : (t - e) / n + 4) + 360) % 6) *
                        60) /
                      360,
                    s: 0 == n ? 0 : n / i,
                    b: i,
                ...
                ? (h[2] && ((n = z(h[2].substring(5), 16)), (i = z(h[2].substring(3, 5), 16)), (r = z(h[2].substring(1, 3), 16))),
                  ...
                  h[5]
                    ...
                    ? ((l = h[6][v](I)),
                      ...
                      l[3] && '%' == l[3].slice(-1) && (a /= 100),
                      e.hsl2rgb(r, i, n, a))
                    : (((h = { r: r, g: i, b: n, toString: ut }).hex = '#' + (16777216 | n | (i << 8) | (r << 16)).toString(16).slice(1)),
            ...
            function xt(t, r, i) {
              ...
              for (
                var s = dt.apply(0, t), o = dt.apply(0, r), l = w(~~(s / 5), 1), h = w(~~(o / 5), 1), u = [], c = [], f = {}, p = i ? 0 : [], d = 0;
                d < l + 1;
                d++
              ) {
            ...
            var yt = (e.pathBBox = function (t) {
              ...
              _t = (e._pathToAbsolute = function (t) {
                ...
                for (
                  var h, u, c = 3 == t.length && 'M' == t[0][0] && 'R' == t[1][0].toUpperCase() && 'Z' == t[2][0].toUpperCase(), p = l, d = t.length;
                  p < d;
                  p++
                ) {
              ...
              Et =
                ...
                (e._extractTransform = function (t, r) {
                    ...
                    for (var c = 0, f = a.length; c < f; c++) {
                      ...
                      't' == w && 3 == _
                        ...
                        ? 2 == _ || 3 == _
                          ...
                          : 5 == _ &&
                            (k ? ((v = B.x(b[3], b[4])), (y = B.y(b[3], b[4])), u.scale(b[1], b[2], v, y)) : u.scale(b[1], b[2], b[3], b[4]),
                            (o *= b[1]),
                            (l *= b[2]))
                  ...
                  (t.matrix = u),
                    ...
                    (h.dx = i = u.e),
                    (h.dy = n = u.f),
                    1 == o && 1 == l && !s && h.bbox ? ((h.bbox.x += +i), (h.bbox.y += +n)) : (h.dirtyT = 1);
                })),
              Nt = function (t) {
                var e = t[0];
              ...
              !(function (t) {
                (e[t] = Wt[t] =
                  function (r, i) {
                    return (
                      e.is(r, 'function') &&
                        ((this.events = this.events || []), this.events.push({ name: t, f: r, unbind: It(this.shape || this.node || l.doc, t, r, i || this) })),
                      this
                    );
                  }),
                  (e['un' + t] = Wt['un' + t] =
            ...
            (i.getElementByPoint = function (t, e) {
              ...
              (Wt.isPointInside = function (t, r) {
                ...
                return (
                  this.attr('transform') && this.attr('transform').length && (i = e.transformPath(i, this.attr('transform'))), e.isPointInsidePath(i, t, r)
                );
              }),
              (Wt.getBBox = function (t) {
                ...
                var e = this._;
                return t
                  ? ((!e.dirty && e.bboxwt) || ((this.realPath = Z[this.type](this)), (e.bboxwt = yt(this.realPath)), (e.bboxwt.toString = Ht), (e.dirty = 0)),
                    e.bboxwt)
            ...
            var Xt = function (t, r, i, n, a, s, o, l, h) {
              ...
              Ut = function (t, r) {
                return function (i, n, a) {
                  for (var s, o, l, h, u, c = '', f = {}, p = 0, d = 0, g = (i = Tt(i)).length; d < g; d++) {
                    if ('M' == (l = i[d])[0]) (s = +l[1]), (o = +l[2]);
                      ...
                      if (p + (h = Xt(s, o, l[1], l[2], l[3], l[4], l[5], l[6])) > n) {
                        if (r && !f.start) {
                          if (((c += ['C' + (u = Xt(s, o, l[1], l[2], l[3], l[4], l[5], l[6], n - p)).start.x, u.start.y, u.m.x, u.m.y, u.x, u.y]), a))
                            return c;
                  ...
                  return (
                    (f.end = c),
                    (u = t ? p : r ? f : e.findDotsAtSegment(s, o, l[0], l[1], l[2], l[3], l[4], l[5], 1)).alpha && (u = { x: u.x, y: u.y, alpha: u.alpha }),
                    u
                  );
                };
              },
            ...
            if (!t || t.svg) {
              ...
              var x = function (i, n) {
                ...
                b = function (i, n, a) {
                  if ('path' == i.type) {
                    ...
                    if (
                      ('open' == w
                        ? ((k += 2), (B += 2), (C += 2), (l = 1), (h = a ? 4 : 1), (u = { fill: 'none', stroke: m.stroke }))
                      ...
                      switch (((u[d] = g), d)) {
                        ...
                        case 'path':
                          'path' == i.type &&
                            ...
                            (i._.dirty = 1),
                            i._.arrows &&
                              ('startString' in i._.arrows && b(i, i._.arrows.startString), 'endString' in i._.arrows && b(i, i._.arrows.endString, 1)));
                          break;
                        case 'width':
                        ...
                        case 'fill-opacity':
                          if (u.gradient) {
                            (F = t._g.doc.getElementById(l.getAttribute('fill').replace(/^url\(#|\)$/g, c))) &&
                              ((z = F.getElementsByTagName('stop')), x(z[z.length - 1], { 'stop-opacity': g }));
                            break;
                          }
                        default:
              ...
              (S.prototype = T),
                ...
                (t._engine.rect = function (t, e, r, i, n, a) {
                  ...
                  var o = new S(s, t);
                  return (
                    (o.attrs = { x: e, y: r, width: i, height: n, rx: a || 0, ry: a || 0, fill: 'none', stroke: '#000' }), (o.type = 'rect'), x(s, o.attrs), o
                  );
                }),
                ...
                (t._engine.setViewBox = function (t, e, r, i, n) {
                  ...
                  for (
                    null == t
                      ? (this._vbSize && (h = 1), delete this._vbSize, (a = '0 0 ' + this.width + f + this.height))
          ...
          (n = function (t) {
            if (!t || t.vml) {
                    ...
                    (a = (a = r(a).replace(t._radial_gradient, function (t, e, r) {
                      return (
                        ...
                        e &&
                          ...
                          ((e = i(e)),
                          (r = i(r)),
                          o(e - 0.5, 2) + o(r - 0.5, 2) > 0.25 && (r = n.sqrt(0.25 - o(e - 0.5, 2)) * (2 * (r > 0.5) - 1) + 0.5),
                          (h = e + c + r)),
                        f
                      );
                    })).split(/\s*\-\s*/)),
              ...
              (T.prototype = A),
                ...
                (A.toFront = function () {
                  return (
                    !this.removed && this.node.parentNode.appendChild(this.node), this.paper && this.paper.top != this && t._tofront(this, this.paper), this
                  );
                }),
                (A.toBack = function () {
                  return this.removed
                ...
                (t._engine.create = function () {
                  ...
                  return (
                    ...
                    1 == r
                      ? (t._g.doc.body.appendChild(l), (h.left = a + 'px'), (h.top = s + 'px'), (h.position = 'absolute'))
                      : r.firstChild
