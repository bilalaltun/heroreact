...
function bootstrapDelegationHandler(e, t, n) {
  return function i(s) {
    ...
    for (let { target: r } = s; r && r !== this; r = r.parentNode)
      for (const a of o) if (a === r) return hydrateObj(s, { delegateTarget: r }), i.oneOff && EventHandler.off(e, s.type, t, n), n.apply(r, [s]);
  };
}
...
const EventHandler = {
  ...
  trigger(e, t, n) {
    ...
    t !== getTypeEvent(t) &&
      i &&
      ((s = i.Event(t, n)), i(e).trigger(s), (o = !s.isPropagationStopped()), (r = !s.isImmediatePropagationStopped()), (a = s.isDefaultPrevented()));
  ...
  _getTemplateFactory(e) {
    return (
      this._templateFactory
        ...
        : (this._templateFactory = new TemplateFactory({ ...this._config, content: e, extraClass: this._resolvePossibleFunction(this._config.customClass) })),
      this._templateFactory
    );
  }
...
class ScrollSpy extends BaseComponent {
  ...
  _activateParents(e) {
    ...
    else for (const t of SelectorEngine.parents(e, '.nav, .list-group')) for (const e of SelectorEngine.prev(t, SELECTOR_LINK_ITEMS)) e.classList.add('active');
  }
  _clearActiveClass(e) {
...
class Tab extends BaseComponent {
  constructor(e) {
    super(e),
      ...
      this._parent && (this._setInitialAttributes(this._parent, this._getChildren()), EventHandler.on(this._element, EVENT_KEYDOWN, (e) => this._keydown(e)));
  }
  static get NAME() {
    return 'tab';
  }
