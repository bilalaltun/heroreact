    ...
    var e = {
        ...
        5417: function (e, t, n) {
          ...
          e.exports = function (e, t) {
            ...
            return (
              i(e) &&
                ('function' != typeof (n = e.constructor) || (n !== Array && !i(n.prototype)) ? r(n) && null === (n = n[o]) && (n = void 0) : (n = void 0)),
      ...
      (function () {
        ...
        var s = {
          ...
          addedfile: function (e) {
            var t = this;
            if (
              (this.element === this.previewsContainer && this.element.classList.add('dz-started'), this.previewsContainer && !this.options.disablePreviews)
            ) {
            ...
            d(
              ...
              [
                ...
                },
                {
                  ...
                  value: function (e) {
                    if (
                      (e.status === i.UPLOADING && this.cancelUpload(e), (this.files = x(this.files, e)), this.emit('removedfile', e), 0 === this.files.length)
                    )
                ...
                },
                {
                  ...
                  value: function (e, t, n) {
                    ...
                    if (
                      (this.options.uploadMultiple && (this.emit('successmultiple', e, t, n), this.emit('completemultiple', e)), this.options.autoProcessQueue)
                    )
