...
!(function (a) {
  ...
  (c.prototype.init = function (b) {
    ...
    b.hooks.bindEvents.push(function (b, g) {
      if (
        ...
        'boolean' == typeof f.plotOptions.tooltip &&
          ((f.plotOptions.tooltipOpts.show = f.plotOptions.tooltip), (f.plotOptions.tooltip = f.plotOptions.tooltipOpts), delete f.plotOptions.tooltipOpts),
    ...
    (c.prototype.stringFormat = function (a, b) {
      ...
      return (
        'undefined' != typeof b.series.xaxis.tickFormatter && (a = a.replace(o, b.series.xaxis.tickFormatter(c, b.series.xaxis).replace(/\$/g, '$$'))),
    ...
    (c.prototype.hasAxisLabel = function (b, c) {
      return (
        -1 !== a.inArray('axisLabels', this.plotPlugins) && 'undefined' != typeof c.series[b].options.axisLabel && c.series[b].options.axisLabel.length > 0
      );
    }),
