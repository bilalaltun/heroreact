!(function (e) {
  ...
  var e,
    ...
    We =
      (((e = document.createElement('div').style).cssText = 'background-color:rgba(0,0,0,.5)'), t(e.backgroundColor, 'rgba') || t(e.backgroundColor, 'hsla')),
    Be = [
  ...
  function n(e, t) {
    var a,
      ...
      h = (function (e, t) {
        (e.locale = e.locale || window.navigator.language),
          ...
          'en' != e.locale && Ne.spectrum.localization[e.locale] && (e = Ne.extend({}, Ne.spectrum.localization[e.locale], e));
        var a = Ne.extend({}, qe, e);
        return (a.callbacks = { move: Ye(a.move, t), change: Ye(a.change, t), show: Ye(a.show, t), hide: Ye(a.hide, t), beforeShow: Ye(a.beforeShow, t) }), a;
      })(t, e),
      s = h.type,
      d = 'flat' == s,
    ...
    function je(e, t) {
      ...
      tinycolor.equals(e, Ae())
        ? Fe()
        : ((e && e !== De) || !ue ? ((ce = !1), (o = (a = tinycolor(e)).toHsv()), (_ = (o.h % 360) / 360), (k = o.s), (P = o.v), (C = o.a)) : (ce = !0),
          Fe(),
        ...
        if ((We || 1 === a.alpha ? re.css('background-color', n) : (re.css('background-color', 'transparent'), re.css('filter', a.toFilter())), h.showAlpha)) {
          ...
          Ve
            ...
            : (W.css('background', '-webkit-' + l),
              ...
              W.css('background', 'linear-gradient(to right, ' + i + ', ' + r + ')'));
        }
        o = a.toString(t);
      }
      ...
      function a(e) {
        return (
          e.data && e.data.ignore
            ...
            : (je(Ne(e.target).closest('.sp-thumb-el').data('color')), Re(), h.hideAfterPaletteSelect ? (Le(!0), Me()) : Le()),
          !1
        );
      }
      ve(),
        ...
        Z.on('click.spectrum', function (e) {
          e.stopPropagation(),
            ...
            h.showPaletteOnly || d || E.css('left', '-=' + (N.outerWidth(!0) + 5)),
            me();
        }),
        Ge(
          B,
        ...
        ne ? (je(ne), Fe(), (ie = tinycolor(ne).format || h.preferredFormat), xe(ne)) : ('' === ne && je(ne), Fe()),
        d && Pe();
      ...
      Ne(s).on('touchstart mousedown', function (e) {
        (e.which ? 3 == e.which : 2 == e.button) ||
          ...
          (!1 !== t.apply(s, arguments) &&
            ((c = !0), (f = Ne(s).height()), (h = Ne(s).width()), (u = Ne(s).offset()), Ne(l).on(a), Ne(l.body).addClass('sp-dragging'), o(e), p(e)));
      });
  }
  function Ue() {
  ...
  (Ne.fn.spectrum = function (a, e) {
    ...
    (function () {
      ...
      function t(e, t, a, o) {
        ...
        return o && r[0].charAt(0) == r[0].charAt(1) && r[1].charAt(0) == r[1].charAt(1) && r[2].charAt(0) == r[2].charAt(1)
      ...
      (h.prototype = {
        ...
        toRgbString: function () {
          return 1 == this._a
            ...
            : 'rgba(' + i(this._r) + ', ' + i(this._g) + ', ' + i(this._b) + ', ' + this._roundA + ')';
        },
