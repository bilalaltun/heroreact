!(function (a, b, c, d) {
  ...
  (e.prototype = {
    init: function () {
      (this.editing = !1),
        this.options.dblclick && a(this.element).css('cursor', 'pointer').bind('dblclick', this.toggle.bind(this)),
        this.options.button && a(this.options.buttonSelector, this.element).bind('click', this.toggle.bind(this));
    },
    toggle: function (a) {
