  ...
  (j.prototype.createControl = function (a) {
    ...
    (b.style.cursor = 'pointer'),
      a.disableDefaultStyles !== !0 &&
        ((b.style.fontFamily = 'Roboto, Arial, sans-serif'), (b.style.fontSize = '11px'), (b.style.boxShadow = 'rgba(0, 0, 0, 0.298039) 0px 1px 4px -1px'));
    ...
    (j.prototype.drawPolyline = function (a) {
      ...
      for (
        var g = new google.maps.Polyline(f), h = ['click', 'dblclick', 'mousedown', 'mousemove', 'mouseout', 'mouseover', 'mouseup', 'rightclick'], i = 0;
        i < h.length;
        i++
      )
        !(function (b, c) {
    ...
    (j.prototype.drawCircle = function (b) {
      ...
      for (
        var c = new google.maps.Circle(b), d = ['click', 'dblclick', 'mousedown', 'mousemove', 'mouseout', 'mouseover', 'mouseup', 'rightclick'], e = 0;
        e < d.length;
        e++
      )
        !(function (a, c) {
    ...
    (j.prototype.drawRectangle = function (b) {
      ...
      b.bounds = c;
      for (
        var d = new google.maps.Rectangle(b), e = ['click', 'dblclick', 'mousedown', 'mousemove', 'mouseout', 'mouseover', 'mouseup', 'rightclick'], f = 0;
        f < e.length;
        f++
      )
        !(function (a, c) {
    ...
    (j.prototype.drawPolygon = function (d) {
      ...
      for (
        var g = new google.maps.Polygon(d), h = ['click', 'dblclick', 'mousedown', 'mousemove', 'mouseout', 'mouseover', 'mouseup', 'rightclick'], i = 0;
        i < h.length;
        i++
      )
        !(function (a, b) {
  ...
  return (
    ...
    Array.prototype.indexOf ||
      (Array.prototype.indexOf = function (a) {
        ...
        if (
          (arguments.length > 1 &&
            ((d = Number(arguments[1])), d != d ? (d = 0) : 0 != d && d != 1 / 0 && d != -(1 / 0) && (d = (d > 0 || -1) * Math.floor(Math.abs(d)))),
          d >= c)
        )
          return -1;
