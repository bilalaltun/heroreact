!(function (t, e) {
  ...
  var gt,
    ...
    kt = function (t) {
      var e,
        ...
        a =
          !!(i = k()) &&
          (i.parentNode.removeChild(i), bt([document.documentElement, document.body], [J['no-backdrop'], J['toast-shown'], J['has-column']]), !0);
      pt()
  ...
  (Mt.text =
      ...
      function (t, e) {
        return (
          'string' == typeof e.inputValue || 'number' == typeof e.inputValue
            ...
            : w(e.inputValue) || W('Unexpected type of inputValue! Expected "string", "number" or "Promise", got "'.concat(r(e.inputValue), '"')),
          St(t, t, e),
          Ot(t, e),
          (t.type = e.input),
          t
    ...
    (Mt.select = function (t, e) {
      ...
      return (
        (t.textContent = ''),
        e.inputPlaceholder &&
          ((n = document.createElement('option')), U(n, e.inputPlaceholder), (n.value = ''), (n.disabled = !0), (n.selected = !0), t.appendChild(n)),
        St(t, t, e),
        t
      );
    }),
  ...
  function Rt(t, o) {
    ...
    r >= o.progressSteps.length &&
      W('Invalid currentProgressStep parameter, it should be less than progressSteps.length (currentProgressStep like JS arrays starts from 0)'),
        ...
        return (
          'object' !== r(n[0]) || C(n[0])
            ? ['title', 'html', 'icon'].forEach(function (t, e) {
                ...
                'string' == typeof e || C(e)
                  ? (o[t] = e)
                  : void 0 !== e && K('Unexpected type of '.concat(t, '! Expected "string" or "Element", got ').concat(r(e)));
              })
            : s(o, n[0]),
          o
        );
  ...
  var ge = function () {
      navigator.userAgent.match(/(CriOS|FxiOS|EdgiOS|YaBrowser|UCBrowser)/i) ||
        (A().scrollHeight > window.innerHeight - 44 && (k().style.paddingBottom = ''.concat(44, 'px')));
    },
    ve = function () {
      var e,
        t = k();
    ...
    G()
      ...
      N() &&
        ...
        F(document.body, J.iosfix) &&
          ((e = parseInt(document.body.style.top, 10)), bt(document.body, J.iosfix), (document.body.style.top = ''), (document.body.scrollTop = -1 * e)),
  ...
  var Ve = ['swal-title', 'swal-html', 'swal-footer'],
    ...
    gn = function (t) {
      -1 !== [T(), L(), q()].indexOf(document.activeElement) &&
        ((t = -1 !== ln.indexOf(t) ? 'nextElementSibling' : 'previousElementSibling'), (t = document.activeElement[t]) && t.focus());
    },
    vn = function (t, e, n) {
    ...
    return new Promise(function (t) {
      ...
      Ce.swalPromiseResolve.set(a, t),
        ...
        'select' === (t = s).input || 'radio' === t.input
          ? tn(r, t)
          : -1 !== ['text', 'email', 'number', 'tel', 'textarea'].indexOf(t.input) && (b(t.inputValue) || w(t.inputValue)) && en(r, t),
        Ie(s),
        Pn(te, s, e),
        En(u, s),
        setTimeout(function () {
    ...
    jn = Object.freeze({
      ...
      showValidationMessage: function (t) {
        ...
        U(e.validationMessage, t),
          ...
          (e = this.getInput()) &&
            (e.setAttribute('aria-invalid', !0), e.setAttribute('aria-describedBy', J['validation-message']), nt(e), vt(e, J.inputerror));
      },
      resetValidationMessage: function () {
        var t = Tt.domCache.get(this);
        t.validationMessage && at(t.validationMessage),
          (t = this.getInput()) && (t.removeAttribute('aria-invalid'), t.removeAttribute('aria-describedBy'), bt(t, J.inputerror));
      },
